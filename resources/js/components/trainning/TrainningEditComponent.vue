                    ...
                    <form action="">
                      <div class="row">
                        ...
                        <div class="col-12">
                          ...
                          <div class="form-row" v-if="trainning.style === 0 || trainning.style === 1">
                            <div class="col-12">
...
<!--                            </div>-->
                          ...
                          <div class="form-row">
                            <div class="col-sm-4 form-group" v-if="trainning.style === 0 || trainning.style === 1">
                ...
                <clone-course v-if="trainning.style === 0 || trainning.style === 1" :id="id" :type="trainning.style"></clone-course>
                <assign-course v-if="trainning.style === 2" :id="id" :type="trainning.style"></assign-course>
