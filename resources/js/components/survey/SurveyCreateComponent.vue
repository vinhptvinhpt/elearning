                ...
                <div class="row">
                  <div class="col-12 col-lg-12">
                    ...
                    <div class="button-list">
                      <button @click="createSurvey()" type="button" class="btn btn-primary">{{trans.get('keys.tao')}}
                      </button>
                    ...
                    .then(response => {
                        if (response.data.status) {
                            swal({
                                ...
                                , function () {
                                  this.$router.push({ name: 'QuestionCreate', params: {survey_id: response.data.otherData} });
                                }
                            );
                        } else {
                            swal({
