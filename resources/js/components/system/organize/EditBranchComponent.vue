      ...
      <div class="col">
        <nav class="breadcrumb" aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent px-0">
            ...
            <li class="breadcrumb-item">
              <router-link v-if="city_id && city_id !== 0" :to="{ name: 'BranchIndexByCity', params: { city: city_id } }">
                {{ trans.get('keys.dai_ly') }}
              </router-link>
              <router-link v-else :to="{ name: 'BranchIndex' }">
                {{ trans.get('keys.dai_ly') }}
              </router-link>
            </li>
                ...
                <div class="row">
                  <div class="col-12">
                    <div class="form-group text-right">
                      <router-link v-if="city_id && city_id !== 0" :to="{ name: 'BranchIndexByCity', params: { city: city_id } }" class="btn btn-secondary btn-sm" style="color: rgb(255, 255, 255);">
                       {{trans.get('keys.quay_lai')}}
                      </router-link>
                      <router-link v-else :to="{ name: 'BranchIndex'}" class="btn btn-secondary btn-sm" style="color: rgb(255, 255, 255);">
                        {{trans.get('keys.quay_lai')}}
                      </router-link>
