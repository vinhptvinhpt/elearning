      ...
      <div class="col">
        <nav class="breadcrumb" aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent px-0">
            ...
            <li v-if="type === 'teacher'" class="breadcrumb-item active">{{ trans.get('keys.quan_tri_giang_vien') }}</li>
            <li v-else-if="type === 'student'" class="breadcrumb-item active">{{ trans.get('keys.quan_tri_hoc_vien') }}</li>
          ...
          <div class="row mb-4">
            <div class="col-sm">
              <div class="accordion" id="accordion_1">
                ...
                <div class="card">
                  <div class="card-header d-flex justify-content-between">
                    <a class="collapsed" role="button" data-toggle="collapse" href="#collapse_2" aria-expanded="false"><i class="fal fa-upload mr-3"></i>{{trans.get('keys.tai_len_file_excel')}}</a>
                  </div>
                ...
                <div class="row">
                  <div class="col-md-12 col-sm-12 dataTables_wrapper">
                    ...
                    <div class="fillterConfirm" style="display: inline-block;" v-if="type == 'system'">
                      <label>
                        <select v-model="roles" class="custom-select custom-select-sm form-control form-control-sm" @change="getUser(1)">
                    ...
                    <div class="fillterConfirm" style="display: inline-block;" v-if="type == 'student'">
                      <label>
                        <select v-model="confirm" class="custom-select custom-select-sm form-control form-control-sm" @change="getUser(1)">
                ...
                <div class="table-responsive">
                  <table class="table_res">
                    ...
                    <tr v-else v-for="(user,index) in posts">
                      <td>
                        <input v-model="user_delete" :value="user.user_id" type="checkbox" :id="'delete_user'+user.user_id" class="filled-in chk-col-light-blue check_box_branch">
                      ...
                      <td class="mobile_hide" v-if="type == 'student'">{{ (user.confirm && user.confirm == 1) ? 'Đã có' : 'Chưa có' }}</td>
                  ...
                  <div class="text-right">
                    <button :title="trans.get('keys.xoa_tai_khoan_da_chon')" type="button" style="float: right;" class="btn btn-sm btn-danger mt-3" @click="deleteSelectUser()">
                      {{trans.get('keys.xoa')}}
                    </button>
                  </div>
                </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            deleteSelectUser(){
                var user_delete = this.user_delete;
