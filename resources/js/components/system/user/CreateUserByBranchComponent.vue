        ...
        <div class="col-12 col-lg-9">
            <form action="" class="form-row hk-sec-wrapper">
                ...
                <div class="col-12 form-group">
                    <label for="inputSaleroom">{{trans.get('keys.noi_lam_viec')}} *</label>
                    <select class="form-control search_text" v-model="sale_room_id" id="inputSaleroom">
                    ...
                    <label v-if="!saleroom" class="required text-danger saleroom_required hide">{{trans.get('keys.truong_bat_buoc_phai_nhap')}}</label>
                </div>
...
<script>
    export default {
        props: ['branch_id','branch_type', 'saleroom_type'],
        data() {
            return {
                fullname: '',
                dob: '',
        ...
        methods: {
            ...
            createUser(){
                this.sale_room_id = parseInt(this.sale_room_id);
                if(!this.username) {
                ...
                this.formData.append('sale_room_id', this.sale_room_id === 0 ? this.branch_id : this.sale_room_id);
