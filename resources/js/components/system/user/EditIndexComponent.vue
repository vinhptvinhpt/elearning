      ...
      <div class="col">
        <nav class="breadcrumb" aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent px-0">
            ...
            <li v-if="type === 'teacher'" class="breadcrumb-item active">{{ trans.get('keys.thong_tin_giang_vien') }}</li>
            <li v-else-if="type === 'student'" class="breadcrumb-item active">{{ trans.get('keys.thong_tin_hoc_vien') }}</li>
