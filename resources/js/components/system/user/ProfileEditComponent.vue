      ...
      <div class="col">
        <nav class="breadcrumb" aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent px-0">
            ...
            <li class="breadcrumb-item">
              <router-link to="/tms/profile">{{ trans.get('keys.thong_tin_ca_nhan') }}</router-link>
            </li>
            ...
            <div class="col-12 col-lg-3">
              <div class="card">
                ...
                <div class="form-group">
                  <div class="card-body">
                    <a class="mb-10 btnShowChangePass" style="cursor: pointer;display:block;text-decoration: underline;"
                    ...
                    <div class="showChangePass" style="display:none;">
                      ...
                      <button type="button" class="btn btn-primary btn-sm" @click="updatePassword()">
                        {{trans.get('keys.cap_nhat_mat_khau')}}
                      </button>
            ...
            <div class="col-12 col-lg-9">
              <form action="" class="form-row">
                <div class="col-4 form-group">
                  ...
                  <input type="text" id="inputUsername" :value="users.username" class="form-control mb-4"
                         autocomplete="false" disabled="true">
                </div>
                <div class="col-4 form-group">
                ...
                <div class="col-4 form-group">
                  ...
                  <input type="text" id="inputFullname" v-model="users.fullname" class="form-control mb-4"
                ...
                <div class="col-4 form-group">
                  ...
                  <input type="text" id="inputEmail" v-model="users.email" class="form-control mb-4"
                         @input="changeRequired('inputEmail')">
              ...
              <div class="button-list">
                ...
                <router-link to="/tms/profile" class="btn btn-secondary btn-sm">{{trans.get('keys.quay_lai')}}
                </router-link>
              </div>
            </div>
          </div>
