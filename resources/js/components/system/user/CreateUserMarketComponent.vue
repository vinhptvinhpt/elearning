    ...
    <div class="col-12 col-lg-9">
      <form action="" class="form-row hk-sec-wrapper" id="user_form_create">
        <!--<div class="col-6 form-group">
            ...
            <select id="inputConfirm" class="form-control custom-select" v-model="confirm" @change="changeConfirm()">
        ...
        <div class="col-6 form-group">
            ...
            <select id="inputConfirmAddress" class="form-control custom-select" v-model="confirm_address" disabled>
        ...
        <div class="col-md-4 col-sm-6 form-group">
          ...
          <span class="wrap_password pass">
                        <input autocomplete="false" v-model="password" type="password" id="inputPassword" placeholder=""
                               class="form-control mb-4" @input="validate_password" readonly>
        ...
        <div class="col-md-4 col-sm-6 form-group">
          ...
          <input v-model="fullname" type="text" id="inputFullname" :placeholder="trans.get('keys.nhap_ho_ten_day_du')"
        ...
        <div class="col-sm-6 form-group">
          <label for="inputAddress">{{trans.get('keys.dia_chi_thuong_chu')}}</label>
          <input v-model="address" type="text" id="inputAddress" :placeholder="trans.get('keys.dia_chi')"
                 class="form-control mb-4">
        </div>
        ...
        <div class="col-12">
          <div class="button-list text-right">
            <button type="button" class="btn btn-secondary btn-sm collapsed closeForm"
                    @click="removeForm('formCreateNew')">{{trans.get('keys.huy')}}
            </button>
            <button @click="createUser()" type="button" class="btn btn-primary btn-sm">{{trans.get('keys.them_moi')}}
            </button>
          </div>
        </div>
      </form>
