      ...
      <div class="col">
        <nav class="breadcrumb" aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent px-0">
            ...
            <li class="breadcrumb-item">
              <router-link to="/tms/system/user">{{ trans.get('keys.quan_tri_nguoi_dung') }}</router-link>
            </li>
              ...
              <div class="table-wrap">
                    ...
                    <form v-on:submit.prevent="getUser(1)">
                      <div class="d-flex flex-row form-group">
                        <input v-model="keyword" type="text"
                               ...
                               :placeholder="trans.get('keys.nhap_ten_dang_nhap_fullname_email') + ' ...'">
                ...
                <div class="table-responsive">
                  ...
                  <div class="text-left">
                    ...
                    <button :title="trans.get('keys.xoa_vinh_vien_tai_khoan_da_chon')" type="button"
                            style="float: right;"
