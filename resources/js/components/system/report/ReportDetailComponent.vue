        ...
        <div class="card-body">
          <div class="row">
            <div class="col-6 mb-1">
              <label for="input-mode">{{trans.get('keys.che_do')}}</label>
              <select id="input-mode" v-model="mode_select" class="form-control mb-0" style="height: 40px;"
                      @change="changeForm(0)">
            ...
            <div class="col-6 mb-1">
              <label for="input-type">{{trans.get('keys.phan_loai')}}</label>
              <select id="input-type"
                      v-model="type_select"
                      class="form-control mb-0"
                      :disabled="mode_select === 'completed_training'"
                      @change="changeForm(1)"
                      style="height: 40px;">
                <option value="training_pqdl">
                  {{ trans.get('keys.training_pqdl')}}
                </option>
                <option value="single_course">
                  {{ trans.get('keys.single_course')}}
                </option>
              </select>
            </div>
            ...
            <div class="col-6 mb-1">
              ...
              <select id="training_select"
                      v-model="training_id"
                      class="custom-select"
                      :disabled="type_select === 'single_course'"
                      @change="fetchCourses()">
            ...
            <div class="col-6 form-inline mb-1">
              <div class="row col-12">
                <label>{{ trans.get('keys.tim_kiem_dua_tren_thoi_gian_hoan_thanh') }}</label>
              </div>
              <datepicker
                id="inputStart"
                :clear-button=true
            ...
            <div class="row">
              ...
              <div class="col-5 text-right">
                <a style="color: #fff;" class="btn btn-sm btn-icon btn-primary btn-icon-style-2"
                   v-on:click="expandAll()" :title="trans.get('keys.xem_chi_tiet')"
                   v-if="report_data.selected_level !== 'city'">
  ...
  export default {
    ...
    methods: {
      ...
      fetchCourses() {
        ...
        if (this.type_select === 'single_course' || this.training_id !== 0) {
      ...
      setData(list, type, parent_key) {
        for (const [key, item] of Object.entries(list)) {
          if (this.type_select === 'single_course') {
            type = "courses";
          }
