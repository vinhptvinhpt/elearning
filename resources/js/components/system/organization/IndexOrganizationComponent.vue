                                ...
                                <div class="card-body">
                                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                <div class="input-group">
                                                    <input type="text" id="organization_name"
                                                           ...
                                                           :placeholder="trans.get('keys.ten_to_chuc')+' *'" required
                                                           v-model="organization.name">
                                                </div>
                                                <label for="organization_name" v-if="!organization.name"
                                                       class="text-danger name_required hide">{{trans.get('keys.truong_bat_buoc_phai_nhap')}}</label>
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group">
                                                <div class="input-group">
                                                    <input type="text" id="organization_code"
                                                           class="form-control form-control-line"
                                                           :placeholder="trans.get('keys.ma_to_chuc')+' *'" required
                                                           v-model="organization.code">
                                                </div>
                                                <label for="organization_code" v-if="!organization.code"
                                                       class="text-danger code_required hide">{{trans.get('keys.truong_bat_buoc_phai_nhap')}}</label>
                                                <em>{{
                                                    trans.get('keys.gom_chu_cai_(viet_lien_khong_dau),chu_so,ky_tu_dac_biet(-_/.)')
                                                    }}</em>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <div class="input-group">
                                                    <input type="text" id="organization_description"
                                                           class="form-control form-control-line"
                                                           :placeholder="trans.get('keys.mo_ta')" required
                                ...
                                <div class="listData">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-7 dataTables_wrapper">
                                            ...
                                            <div v-if="max_level > 0" class="fillterConfirm"
                                        ...
                                        <div class="col-sm-5">
                                            <form v-on:submit.prevent="getDataList(1)">
                                                <div class="d-flex flex-row form-group">
                                                    ...
                                                    <a v-if="selected_role === 'root' || selected_role === 'admin'"
                                                       class="btn btn-primary btn-sm" @click="switchTreeView()">
                                                        <i v-if="display === 'grid'" class="fal fa-list"
                                                           style="color: white; vertical-align: bottom !important;"></i>
                                                        <i v-if="display === 'tree'" class="fal fa-area-chart"
                                                           style="color: white; vertical-align: bottom !important;"></i>
                                                    </a>
                                                </div>
                                            </form>
                                    ...
                                    <template v-if="display === 'grid'">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table_res">
                                                ...
                                                <th class="d-none d-sm-table-cell">{{trans.get('keys.ten_to_chuc')}}
                                                </th>
                                                ...
                                                <th class="text-center d-none d-sm-table-cell">
                                                    {{trans.get('keys.teams')}}
                                                </th>
                                                <th v-if="slug_can('tms-system-organize-edit') || slug_can('tms-system-organize-deleted')"
                                                    class="text-center" style="min-width: 130px;">
                                                ...
                                                <tr v-else v-for="(item,index) in posts">
                                                    ...
                                                    <td class="d-none d-sm-table-cell" v-if="item.parent">{{
                                                        item.parent.code }} - {{
                                                        item.parent.name }}
                                                    </td>
                                                    ...
                                                    <td class="text-center"
                                                        v-if="slug_can('tms-system-organize-edit') || slug_can('tms-system-organize-deleted')">
                                                        ...
                                                        <router-link v-if="slug_can('tms-system-organize-edit')"
                                                                     :title="trans.get('keys.them_nguoi_dung_ngoai_le')"
                                                                     class="btn btn-sm btn-icon btn-icon-circle btn-success btn-icon-style-2"
                                                                     :to="{ name: 'UserExceptionComponent', params: { id: item.id}}">
                                                        ...
                                                        <a v-if="slug_can('tms-system-organize-deleted')"
                                                           href="javascript(0)"
