                    ...
                    <div class="col-sm-5">
                      <form v-on:submit.prevent="getDataList(1)">
                        <div class="d-flex flex-row form-group">
                          ...
                          <button v-if="selected_role === 'root' || selected_role === 'admin'" type="button"
                                  class="btn btn-primary btn-sm btn_fillter" @click="switchTreeView()">
                      ...
                      <table class="table_res">
                        ...
                        <tr v-else v-for="(item,index) in posts">
                          ...
                          <td class="text-center">
                            ...
                            <router-link v-if="slug_can('tms-system-employee-view')"
                                         :title="trans.get('keys.xem_nhan_vien')"
