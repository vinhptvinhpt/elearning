      ...
      <div class="col">
        <nav class="breadcrumb" aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent px-0">
            ...
            <li class="breadcrumb-item"><router-link to="/tms/education/course/course_sample">{{ trans.get('keys.thu_vien_khoa_hoc') }}</router-link></li>
            <li class="breadcrumb-item active">{{ trans.get('keys.chinh_sua_thong_tin_thu_vien_khoa_hoc') }}</li>
          </ol>
        </nav>
      </div>
    </div>
