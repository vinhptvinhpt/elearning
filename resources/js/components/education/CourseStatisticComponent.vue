                        ...
                        <form v-on:submit.prevent="getStatictisUserCourse(1)">
                          <div class="d-flex flex-row form-group">
                            <input v-model="keyword" type="text"
                                   class="form-control"
                                   :placeholder="trans.get('keys.nhap_thong_tin_tim_kiem_theo_ten_dang_nhap_hoac_ten_hoc_vien')+' ...'">
                      ...
                      <tr v-for="(att,index) in modules">
                        ...
                        <td>
                          <template v-if="att.id !== module_id">
                            <a style="cursor: pointer;" class="btn btn-sm btn-default"
                               @click="getLogCourse(att.id, 1, 'set')">{{ att.name }}</a>
                          </template>
                          <template v-else>
                            <a style="cursor: pointer; color: #ffffff" class="btn btn-sm btn-primary"
                               @click="getLogCourse(att.id, 1, 'set')">{{ att.name }}</a>
                          </template>
                        </td>
                      </tr>
                  ...
                  <div class="table-wrap">
                    <div class="row">
                      ...
                      <div class="col-7 dataTables_wrapper_search">
                        <form v-on:submit.prevent="getLogCourse(module_id, 1, 'search')">
                          <div class="d-flex flex-row form-group">
