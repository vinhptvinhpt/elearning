                ...
                <div class="col-sm">
                  <div class="table-wrap">
                    ...
                    <div class="table-responsive">
                      ...
                      <v-pagination v-model="currentAtt" @input="onPageChange" :page-count="totalPagesAtt"
                                    :classes=$pagination.classes :labels=$pagination.labels></v-pagination>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="table-responsive">
                    <table id="datable_course_module" class="table_res">
                      ...
                      <tr v-for="(att,index) in modules">
                        <td>{{ index+1 }}</td>
                        <td><a style="color: #007bff;cursor: pointer;" @click="getLogCourse(att.id, 1)">{{ att.name
                          }}</a>
                        </td>
                      </tr>
                      </tbody>
...
<!--                          <td>{{ isset(JSON.parse(att.other).name) ? JSON.parse(att.other).name : att.name }}</td>-->
                          <td v-if="JSON.parse(att.other) !== undefined">{{ JSON.parse(att.other).name }}</td>
                      ...
                      <v-pagination v-model="currentDoc" @input="onPageChange" :page-count="totalPagesDoc"
                                    :classes=$pagination.classes :labels=$pagination.labels></v-pagination>
                    </div>
                  </div>
                </div>
