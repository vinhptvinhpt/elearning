        ...
        <section class="hk-sec-wrapper">
          ...
          <div class="row mt-20" v-if="replied === 0">
              ...
              <form class="form-row" id="confirm-form">
                  ...
                  <h6 class="d-inline-flex">
                      <span class="inline-checkbox ml-3">
                          <span class="custom-control custom-checkbox custom-control-inline">
                              <input v-model="accepted" type="checkbox" class="custom-control-input chb" id="checkbox_accepted">
                ...
                <div class="col-12 form-group">
                  <h6 class="d-inline-flex">
                      <span class="inline-checkbox ml-3">
                          <span class="custom-control custom-checkbox custom-control-inline">
                              <input v-model="rejected" type="checkbox" class="custom-control-input chb" id="checkbox_rejected">
            ...
            <div class="col-12 button-list">
              <button type="button" class="btn btn-primary" @click="confirmInvitation()">{{trans.get('keys.xac_nhan')}}</button>
            </div>
          </div>
