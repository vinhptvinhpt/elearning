            ...
            <div class="col">
                <nav class="breadcrumb" aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent px-0">
                        ...
                        <li class="breadcrumb-item active">{{ trans.get('keys.khung_nang_luc_effect') }}</li>
                    </ol>
                </nav>
            </div>
        </div>
                                    ...
                                    <tr v-for="(sur,index) in trainnings">
                                        ...
                                        <td class="text-center">
                                            ...
                                            <router-link
                                                    ...
                                                    :to="{ name: 'CompetencyEditComponent', params: { id: sur.id }}">
...
<script>
    import CompetencyCreate from './CompetencyCreateComponent'

    export default {
        props: ['type', 'slugs'],
        //components: {vPagination},
        components: {CompetencyCreate},
        data() {
            return {
                trainnings: [],
                keyword: '',
        ...
        methods: {
            ...
            getTrainnings(paged) {
                axios.post('/api/tnd-report/getall', {
            ...
            onPageChange() {
                ...
                if (sessionStorage.getItem('competencyBack') === '1') {
                    this.current = Number(sessionStorage.getItem('competencyPage'));
                    this.row = Number(sessionStorage.getItem('competencyPageSize'));
                    this.keyword = sessionStorage.getItem('competencyKeyWord');
            ...
            deletePost(id) {
                ...
                swal({
                    ...
                    axios.post('/api/tnd-report/delete/',
                        {
                            id: id
                        })
                        .then(response => {
        ...
        destroyed() {
            sessionStorage.setItem('competencyBack', '1');
            sessionStorage.setItem('competencyPage', this.current);
            sessionStorage.setItem('competencyPageSize', this.row);
            sessionStorage.setItem('competencyKeyWord', this.keyword);
        }
    }
</script>
