            ...
            <div class="col-xl-12">
                <section class="hk-sec-wrapper">
                    ...
                    <h5 class="hk-sec-title" v-else-if="type == 'teacher'">
                        {{trans.get('keys.them_moi_du_lieu_excel')}}</h5>
                                ...
                                <div class="card">
                                    <div class="card-header d-flex justify-content-between">
                                        <a class="" role="button" data-toggle="collapse" href="#collapse_2"
                                           aria-expanded="true"><i class="fal fa-upload mr-3"></i>{{trans.get('keys.tai_len_file_excel')}}</a>
                                    </div>
                                    <div id="collapse_2" class="collapse show" data-parent="#accordion_1">
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-4">
                                                    <p class="mb-3">
                                                        <a :href="file_url" class="btn px-0 not_shadow"><i
                                            ...
                                            <div class="button-list">
                                                <button type="button" class="btn btn-primary btn-sm hasLoading"
                                                        @click="importExcel()">{{trans.get('keys.import_excel')}}<i
