<template>
  <nav class="hk-nav hk-nav-light">
    <a href="javascript:void(0);" id="nav_close" class="nav-close"
      ><i class="fa fa-arrow-left" aria-hidden="true"></i
    ></a>
    <div class="nicescroll-bar">
      <div class="navbar-nav-wrap">
        <ul class="navbar-nav flex-column" @click="checkToken();">
          ...
          >
            <a
              class="nav-link has-submenu collapse-level-1"
              id="quan_ly_he_thong"
            ...
            <ul id="auth_drp" class="nav flex-column collapse collapse-level-1">
              ...
              >
                <router-link
                  :to="{
                    path: '/tms/system/organize/branchsystem/organize/branch',
                    name: 'BranchIndex',
                    query: { city: '0' },
                  }"
                  class="nav-link"
              ...
              >
                <router-link to="/tms/system/organize/saleroom" class="nav-link">
                  <span class="nav-link-text">
                    {{ trans.get("keys.quan_ly_diem_ban") }}</span
                  >
                </router-link>
              </li>
              ...
              >
                <router-link to="/tms/system/view_user_market" class="nav-link">
                  <span class="nav-link-text">
                    {{ trans.get("keys.quan_ly_nhan_vien_ban_hang") }}</span
                  >
                </router-link>
              </li>
              ...
              <li
                class="nav-item hide"
                v-if="
                  current_roles.has_master_agency &&
                  slug_can('tms-access-manage-branch-view')
                "
              >
                <router-link to="/tms/branch/list" class="nav-link">
                  <span class="nav-link-text">
                    {{ trans.get("keys.dai_ly_cua_toi") }}</span
                  >
                </router-link>
              </li>
              ...
              <li class="nav-item" v-if="slug_can('tms-system-organize-view')">
                <router-link to="/tms/organization" class="nav-link">
                  <span class="nav-link-text">
                    {{ trans.get("keys.co_cau_to_chuc") }}</span
                  >
                </router-link>
              </li>
              ...
              <li class="nav-item" v-if="slug_can('tms-system-employee-view')">
                <router-link
                  :to="{
                    path: '/tms/organization-employee',
                    query: { view_mode: 'recursive' },
                  }"
                  class="nav-link"
                >
                  <span class="nav-link-text">
                    {{ trans.get("keys.quan_ly_nhan_vien") }}</span
                  >
                </router-link>
              </li>
                ...
                >
                  ...
                  <li class="nav-item">
                    <router-link to="/tms/system/organize/city" class="nav-link">
                      <span class="nav-link-text">
                        {{ trans.get("keys.tinh_thanh") }}</span
                      >
                    </router-link>
                  </li>
                  <li class="nav-item">
                    <router-link
                      :to="{ path: '/tms/system/organize/branch', query: { city: '0' } }"
                      class="nav-link"
                    >
                ...
                >
                  <li class="nav-item" v-if="slug_can('tms-system-user-view')">
                    <router-link to="/tms/system/user" class="nav-link">
                      <span class="nav-link-text">
                        {{ trans.get("keys.danh_sach_nguoi_dung") }}</span
                      >
                    </router-link>
                  </li>
                  ...
                  <li class="nav-item" v-if="slug_can('tms-system-teacher-view')">
                    <router-link to="/tms/education/user_teacher" class="nav-link">
                      <span class="nav-link-text">
                        {{ trans.get("keys.giang_vien") }}</span
                      >
                    </router-link>
                  </li>
                  ...
                  <li
                    class="nav-item"
                    v-if="
                      slug_can('tms-system-trash-restore') ||
                      slug_can('tms-system-trash-clear')
                    "
                  >
                    <router-link to="/tms/system/user/trash" class="nav-link">
                      <span class="nav-link-text">
                        {{ trans.get("keys.recycle_bin") }}</span
                      >
                    </router-link>
                  </li>
                </ul>
              ...
              <li class="nav-item" v-if="slug_can('tms-system-role-view')">
                <router-link to="/tms/role" class="nav-link">
                  <span class="nav-link-text">
                    {{ trans.get("keys.quan_ly_quyen") }}</span
                  >
                </router-link>
              </li>
              ...
              <li class="nav-item" v-if="slug_can('tms-system-import-user-view')">
                <a
                  class="nav-link has-submenu collapse-level-2"
                  id="nhap_du_lieu_bang_excel"
                  @click="
                    toggleMenu('nhap_du_lieu_bang_excel', 'nhap_du_lieu_bang_excel_menu')
                  "
                  href="javascript:void(0);"
                  data-level="collapse-level-2"
                >
                ...
                <ul
                  id="nhap_du_lieu_bang_excel_menu"
                  class="nav flex-column collapse collapse-level-2"
                >
                  <li class="nav-item" v-if="slug_can('tms-system-user-view')">
                    <router-link to="/tms/excel/import/user" class="nav-link">
                      <span class="nav-link-text">
                        {{ trans.get("keys.nhap_du_lieu_nguoi_dung") }}</span
                      >
                    </router-link>
                  </li>
                  <li class="nav-item">
                    <router-link to="/tms/excel/import/user_mark" class="nav-link">
                      <span class="nav-link-text">
                        {{ trans.get("keys.nhap_du_lieu_diem_co_san") }}</span
                      >
                    </router-link>
                  </li>
                </ul>
          ...
          <li
            class="nav-item"
            v-if="
              slug_can('tms-educate-exam-online-view') ||
            ...
            <ul id="pages_drp" class="nav flex-column collapse collapse-level-1">
              <li class="nav-item" v-if="slug_can('tms-educate-libraly-view')">
                <router-link to="/tms/education/course/course_sample" class="nav-link">
                  <span class="nav-link-text">
                    {{ trans.get("keys.thu_vien_khoa_hoc") }}</span
                  >
                </router-link>
              </li>
              ...
              >
                ...
                <ul id="recover_drp12" class="nav flex-column collapse collapse-level-2">
                  ...
                  <li class="nav-item" v-if="slug_can('tms-educate-exam-offline-view')">
                    <router-link
                      to="/tms/education/course/list_concentrate"
                      class="nav-link"
                    >
                      <span class="nav-link-text">
                        {{ trans.get("keys.khoa_dao_tao_tap_trung") }}</span
                      >
                    </router-link>
                  </li>
                  ...
                  <li class="nav-item" v-if="slug_can('tms-educate-exam-clone-add')">
                    <router-link to="/tms/education/course/clone/new" class="nav-link">
                      <span class="nav-link-text">
                        {{ trans.get("keys.tao_moi_khoa_tu_thu_vien") }}</span
                      >
                    </router-link>
                  </li>
                  ...
                  <li class="nav-item" v-if="slug_can('tms-educate-exam-restore-view')">
                    <router-link to="/tms/education/course/list_restore" class="nav-link">
                      <span class="nav-link-text">
                        {{ trans.get("keys.khoi_phuc_khoa_dao_tao") }}</span
                      >
                    </router-link>
                  </li>
                </ul>
              ...
              <li class="nav-item" v-if="slug_can('tms-trainning-view')">
                ...
                <ul id="recover_drp" class="nav flex-column collapse collapse-level-2">
                  <li class="nav-item" v-if="slug_can('tms-trainning-view')">
                    <router-link
                      :to="{
                        path: '/tms/trainning/certification',
                    ...
                    >
                      <span class="nav-link-text">
                        {{ trans.get("keys.khung_nang_luc") }}</span
                      >
                    </router-link>
                  </li>
                  <li class="nav-item" v-if="slug_can('tms-trainning-view')">
                    ...
                    >
                      <span class="nav-link-text">
                        {{ trans.get("keys.khung_nang_luc_theo_thoi_gian") }}</span
                      >
                    </router-link>
                  </li>
                  <li class="nav-item" v-if="slug_can('tms-trainning-view')">
                    ...
                    >
                      <span class="nav-link-text">
                        {{ trans.get("keys.khung_nang_luc_nhom") }}</span
                      >
                    </router-link>
                  </li>
                  <li class="nav-item" v-if="slug_can('tms-trainning-view')">
                    <router-link
                      :to="{
                        path: '/tms/competency/list',
                        name: 'CompetencyListComponent',
                      }"
                      class="nav-link"
                    >
                      <span class="nav-link-text">
                        {{ trans.get("keys.khung_nang_luc_effect") }}</span
                      >
                    </router-link>
                  </li>
                  <!--                                    <li class="nav-item">-->
              ...
              >
                ...
                <ul id="certificate" class="nav flex-column collapse collapse-level-2">
                  <li class="nav-item" v-if="slug_can('tms-educate-uncertificate-view')">
                    <router-link
                      to="/tms/certificate/student/uncertificate"
                      class="nav-link"
                    >
                      <span class="nav-link-text">
                        {{ trans.get("keys.cap_giay_chung_nhan") }}</span
                      >
                    </router-link>
                  </li>
                  <li class="nav-item" v-if="slug_can('tms-educate-certificate-view')">
                    ...
                    >
                      <span class="nav-link-text">
                        {{ trans.get("keys.chung_chi_mau") }}</span
                      >
                    </router-link>
                  </li>
                  <li class="nav-item" v-if="slug_can('tms-educate-certificate-view')">
                    ...
                    >
                      <span class="nav-link-text">
                        {{ trans.get("keys.huy_hieu_mau") }}</span
                      >
                    </router-link>
                  </li>
              ...
              <li class="nav-item" v-if="slug_can('tms-report-survey-view')">
                ...
                >
                <ul id="recover_drp1" class="nav flex-column collapse collapse-level-2">
                  <li class="nav-item">
                    <router-link to="/tms/survey/list" class="nav-link">
                      <span class="nav-link-text">
                        {{ trans.get("keys.danh_sach_survey") }}</span
                      >
                    </router-link>
                  </li>
                  <li class="nav-item">
                    <router-link to="/tms/question/list" class="nav-link">
                      <span class="nav-link-text">
                        {{ trans.get("keys.danh_sach_cau_hoi") }}</span
                      >
                    </router-link>
                  </li>
                  <li class="nav-item">
                    <router-link to="/tms/survey/restore" class="nav-link">
                      <span class="nav-link-text">
                        {{ trans.get("keys.khoi_phuc_survey") }}</span
                      >
                    </router-link>
                  </li>
                </ul>
                ...
                >
                  <li class="nav-item">
                    <router-link to="/tms/self/list" class="nav-link">
                      <span class="nav-link-text">
                        {{ trans.get("keys.danh_sach_self") }}</span
                      >
                    </router-link>
                  </li>
                  <li class="nav-item">
                    <router-link to="/tms/selfquestion/list" class="nav-link">
                      <span class="nav-link-text">
                        {{ trans.get("keys.danh_sach_cau_hoi_self") }}</span
                      >
                    </router-link>
                  </li>
                </ul>
          ...
          <li
            class="nav-item"
            v-if="slug_can('tms-report-base-view') || slug_can('tms-report-report-view')"
          >
            <a
              class="nav-link has-submenu collapse-level-1"
              href="javascript:void(0);"
              id="bao_cao"
              @click="toggleMenu('bao_cao', 'bc_drp12')"
              data-level="collapse-level-1"
            >
              <i class="fa fa-bell-o" aria-hidden="true"></i>
              <span class="nav-link-text">{{ trans.get("keys.bao_cao") }}</span>
            </a>
            <ul id="bc_drp12" class="nav flex-column collapse collapse-level-1">
              ...
              <li class="nav-item" v-if="slug_can('tms-report-report-view')">
                <router-link to="/tms/report/detail" class="nav-link">
                  <span class="nav-link-text">
                    {{ trans.get("keys.bao_cao_danh_gia") }}</span
                  >
                </router-link>
              </li>
              <li class="nav-item" v-if="slug_can('tms-report-report-view')">
                <router-link to="/tms/report/login_statistic" class="nav-link">
                  <span class="nav-link-text">
                    {{ trans.get("keys.thong_ke_truy_cap") }}</span
                  >
                </router-link>
              </li>
              <li class="nav-item">
                <router-link to="/tms/excel/export/user_mark" class="nav-link">
                  <span class="nav-link-text">
                    {{ trans.get("keys.training_effect_report") }}</span
                  >
                </router-link>
              </li>
            </ul>
          ...
          <li
            class="nav-item"
            v-if="
              slug_can('tms-setting-configuration-view') ||
            ...
            <ul id="bc_drp23" class="nav flex-column collapse collapse-level-1">
              ...
              <li class="nav-item" v-if="slug_can('tms-setting-email-template-view')">
                <router-link to="/tms/email_template/list" class="nav-link">
                  <span class="nav-link-text">
                    {{ trans.get("keys.cau_hinh_template_email") }}</span
                  >
                </router-link>
              </li>
              ...
              <li class="nav-item">
                <router-link to="/tms/faq/list" class="nav-link">
                  <span class="nav-link-text">
                    {{ trans.get("keys.danh_sach_faq") }}</span
                  >
                </router-link>
              </li>
...
export default {
  ...
  methods: {
    ...
    checkToken() {
      ...
      axios
        .post("/api/system/user/user_token", {
          user_id: user_id,
        })
        .then((response) => {
