    ...
    <ul class="navbar-nav hk-navbar-content">
      <li class="nav-item dropdown dropdown-authentication">
        ...
        <div class="dropdown-menu dropdown-menu-right" data-dropdown-in="flipInX" data-dropdown-out="flipOutX">
          ...
          <a v-if="current_roles.root_user" class="dropdown-item" href="/tms/configuration"><i
      ...
      <li class="nav-item dropdown dropdown-notifications">
        <div class="dropdown-menu dropdown-menu-right" data-dropdown-in="fadeIn" data-dropdown-out="fadeOut">
          <h6 class="dropdown-header">{{ trans.get('keys.thong_bao') }} <a href="javascript:void(0);" class="">Xem tất
            cả</a></h6>
          <div class="notifications-nicescroll-bar">
            <a href="javascript:void(0);" class="dropdown-item">
              <div class="media">
                ...
                <div class="media-body">
                  <div>
                    <div class="notifications-text"><span class="text-dark text-capitalize">{{ username }}</span><br>{{
                      trans.get('keys.da_them_ban_vao_khoa_hoc') }} <strong>ABC001</strong></div>
  ...
  export default {
    ...
    mounted() {
      ...
      if(this.imgLogo.length == 0){
        this.imgLogo.length = '/assets/dist/img/logo-black.png';
      }
    },
    updated() {
      this.openMenu();
