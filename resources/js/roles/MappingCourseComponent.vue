        ...
        <div class="card">
          <div class="card-header d-flex justify-content-between">
            <a role="button" data-toggle="collapse" href="#collapse_2" aria-expanded="true">
              <i class="fal fa-plus mr-3"></i>{{trans.get('keys.phan_quyen_du_lieu')}}
            </a>
          </div>
                        ...
                        <div class="table-wrap">
                          <div class="row">
                            <div class="col-lg-5 col-sm-10 mb-3">
                              <h6 class="hk-sec-title">{{trans.get('keys.danh_sach_khoa_hoc')}}</h6>
                              ...
                              <table id="datable_1" class="table_res">
                                ...
                                <tr>
                                  ...
                                  <th class="text-center">
                                    <input class="selection-all" type="checkbox" v-model="allSelected"
                            ...
                            <div class="col-lg-5">
                              <h6 class="hk-sec-title">
                                {{trans.get('keys.danh_sach_khoa_hoc_da_cap')}}</h6>
                              <div class="row">
                                <div class="col-12">
                              ...
                              <table id="datable_2" class="table_res">
                                ...
                                <tr>
                                  ...
                                  <th class="text-center">
                                    <input class="selection-all" type="checkbox" v-model="allSelectedRemove"
                                ...
                                <tr v-for="(course_inside,index) in currentUserEnrols">
                                  ...
                                  <td class=" mobile_hide">{{ course_inside.fullname }}</td>
                                  <td class="text-center">
                                    <input class="selection-child" type="checkbox" :value="course_inside.id"
                                           v-model="userRemoveEnrol" @change="onCheckboxRemoveEnrol()"/>
                                  </td>
                                </tr>
                                </tbody>
                              </table>
  ...
  export default {
    ...
    methods: {
      ...
      enrolUserToCourse() {
        ...
        axios.post('/api/role/mapping_course', {
      ...
      removeEnrolUserToCourse() {
        ...
        axios.post('/api/role/remove_mapping_course', {
