...
CKEDITOR.lang['en'] = {
  ...
  "templates": {
    "button": "Built-in templates",
    "emptyListMsg": "(No built-in templates defined)",
    "insertOption": "Replace existing content",
    "options": "Prebuilt template options",
    "selectPromptMsg": "Please select the built-in template to open in the <br> editor (existing content will be lost):",
    "title": "Built-in Template Content"
  },
  "table": {
    "border": "Border size",
    "caption": "Caption",
  ...
  "smiley": {
    "options": "Emoticon image options",
    "title": "Insert emotional expression (smiley face)",
    "toolbar": "Emotional images (smiley faces)"
  },
  ...
  "save": {"toolbar": "Save"},
  "removeformat": {"toolbar": "Remove formatting"},
  "print": {"toolbar": "Print"},
  ...
  "pagebreak": {"alt": "Page break", "toolbar": "Insert page break"},
  "notification": {"closed": "Notification closed."},
  "newpage": {"toolbar": "New page"},
  "maximize": {"maximize": "maximize maximize", "minimize": "maximize maximize"},
  "magicline": {"title": "Insert paragraph here"},
  "liststyle": {
    "bulletedTitle": "Unordered list property",
    "circle": "Circle piercing",
    "decimal": "Number type (1, 2, 3 ...)",
    "disc": "Disc image",
    "lowerAlpha": "LowerAlpha type (a, b, c, d, e ...)",
    "lowerRoman": "Ordinary Roman Numbers (i, ii, iii, iv, v ...)",
    "none": "Nothing",
    "notset": "<not set>",
    "numberedTitle": "Attribute ordered list",
    "square": "Square",
    "start": "Start",
    "type": "Type type",
    "upperAlpha": "ABC FLOWER (A, B, C, D, E ...)",
    "upperRoman": "FLOWER Roman Numbers (I, II, III, IV, V ...)",
    "validateStartNumber": "The number at the start of the list must be an integer."
  },
  ...
  "iframe": {
    ...
    "noUrl": "Please enter iframe address",
    "scrolling": "Activate scroll bar",
    "title": "Iframe attribute",
    "toolbar": "Iframe"
  },
  ...
  "font": {
    "fontSize": {"label": "Font Size", "voiceLabel": "Font Size", "panelTitle": "Font Size"},
    "label": "Font",
    "panelTitle": "Font",
    "voiceLabel": "Font"
  },
  "flash": {
    ...
    "alignAbsBottom": "Under absolute",
    "alignAbsMiddle": "Between absolute",
    "alignBaseline": "Baseline",
    "alignTextTop": "Above the text",
    "bgcolor": "Background color",
    "chkFull": "Enable full screen",
    "chkLoop": "Loop",
    ...
    "quality": "Quality",
    "qualityAutoHigh": "High automatically",
    "qualityAutoLow": "Automatic Low",
    "qualityBest": "Best",
    "qualityHigh": "High",
    "qualityLow": "Low",
    ...
    "validateHSpace": "The horizontal padding must be an integer.",
    "validateSrc": "Please include link",
    "validateVSpace": "The vertical padding must be an integer.",
  ...
  "find": {
    ...
    "findWhat": "Find string:",
    "matchCase": "Case sensitive",
    "matchCyclic": "Partially like",
    "matchWord": "Like the whole word",
    "notFoundMsg": "The search string could not be found.",
    "replace": "Replace",
    "replaceAll": "Replace All",
    "replaceSuccessMsg": "% 1 position has been replaced.",
  ...
  "div": {
    "IdInputLabel": "Identifier (id)",
    "advisoryTitleInputLabel": "Guide title",
    "cssClassInputLabel": "CSS Classes",
    "edit": "Edit",
    ...
    "toolbar": "Block creation of elements"
  },
  "copyformatting": {
  ...
  "colorbutton": {
    "auto": "Auto", "bgColorTitle": "Background color", "colors": {
      "000": "Black",
      "800000": "Maroon",
      "8B4513": "Saddle Brown",
      ...
      "7F8C8D": "Cyan green",
      "999": "Dark gray"
    }, "more": "Other colors ...", "panelTitle": "Color", "textColorTitle": "Text color"
  },
  "clipboard": {
    "copy": "Copy",
  ...
  "bidi": {"ltr": "Text facing left to right", "rtl": "Text facing right to left"},
  "basicstyles": {
    "bold": "Bold",
    "italic": "Italic",
