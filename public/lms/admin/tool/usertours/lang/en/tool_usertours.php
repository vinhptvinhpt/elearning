...
$string['tour1_title_end'] = 'Kết thúc giới thiệu';
$string['tour1_content_end'] = 'Bạn đã hoàn thành phần giới thiệu cơ bản. Nếu có thắc mắc gì xin vui lòng liên hệ quản trị. Chúc bạn học tập tốt !';
...
$string['tour2_title_end'] = 'Kết thúc giới thiệu';
$string['tour2_content_end'] = 'Bạn đã hoàn thành phần giới thiệu cơ bản. Nếu có thắc mắc gì xin vui lòng liên hệ quản trị. Chúc bạn học tập tốt !';
...
// 3.6 Dashboard tour.
$string['tour3_title_dashboard'] = 'Trang chủ';
$string['tour3_content_dashboard'] = 'Màn hình trang chủ bao gồm các thông tin tổng quát dành cho bạn';
$string['tour3_title_timeline'] = 'Timeline (Lịch trình) liệt kê nhưng hoạt động sắp diễn ra trong thời gian tới';
$string['tour3_content_timeline'] = 'Timeline (Lịch trình) Liệt kê những hoạt động quan trọng sắp diễn ra

Bạn có thể lựa chọn hiển thị hoạt động theo tuần, tháng trong tương lai

Bạn cũng có thể xem các hoạt động đã quá hạn.';
...
$string['tour3_title_overview'] = 'Khoá học chứng chỉ';
$string['tour3_content_overview'] = 'Ở đây sẽ hiển thị các khoá học lấy chứng chỉ dành cho học viên

Nếu các khoá học đang diễn ra và bạn tham gia hoạt động thì sẽ có thanh tiến độ học theo dõi';
$string['tour3_title_starring'] = 'Đánh dấu hoặc ẩn khoá học';
$string['tour3_content_starring'] = 'Bạn có thể lựa chọn đánh dấu (star) để làm nổi bật khoá học hoặc ẩn (hide) trong trường hợp không muốn hiển thị khoá học

Những tác vụ này chỉ có tác dụng đến việc ảnh hưởng, không có chức năng phải quản trị khoá học
...
// 3.6 Messaging tour.
$string['tour4_title_messaging'] = 'Mục tin nhắn';
$string['tour4_content_messaging'] = 'Bao gồm các tin nhắn của bạn hoặc nhóm tham, bạn có thể quản lý các tin nhắn ở đây';
$string['tour4_title_icon'] = 'Tin nhắn';
$string['tour4_content_icon'] = 'Bạn có thể vào mục tin nhắn bằng cách ấn vào biểu tượng này.

Toàn bộ tin nhắn đã xem hay chưa xem đều được liệt kê hết ở đây.

Ấn vào biểu tượng này sẽ dẫn bạn sang hướng dẫn phần tin nhắn.';
...
$string['tour_final_step_title'] = 'Kết thúc giới thiệu';
$string['tour_final_step_content'] = 'Bạn đã hoàn thành phần giới thiệu cơ bản. Nếu có thắc mắc gì xin vui lòng liên hệ quản trị. Chúc bạn học tập tốt !';
