...
// [VinhPT]
// Custom lang common
$string['tmssite'] = 'Traning management';
$string['listcourseavailable'] = 'Available courses';
$string['dashboardtext'] = 'Dashboard';
$string['attendancelabel'] = 'Attendance';
$string['offlinegradelabel'] = 'Offline grade';
$string['activityloglabel'] = 'Activity log';
$string['coursecontentlabel'] = 'Course content';
$string['introductionlabel'] = 'Course introduction';
$string['availabelcourselabel'] = 'Available courses';
$string['allcoursetext'] = 'All courses';
$string['coursenametext'] = 'Course name';
$string['coursecategorylabel'] = 'Course category';
$string['teacherlisttext'] = 'Teachers';
$string['numberofstudent'] = 'Number of students';
$string['numberofactivity'] = 'Number of activities';
$string['progressbar'] = 'Progress';
$string['learnnow'] = 'Learn now';
$string['courseinformation'] = 'Course overview';
$string['courseplace'] = 'Classroom';
$string['coursestartdate'] = 'Start date';
$string['courseenddate'] = 'End date';
$string['coursegradepass'] = 'Passing grade';
$string['indexlabel'] = 'Index';
$string['accountlabel'] = 'Username';
$string['usernamelabel'] = 'Fullname';
$string['presentlabel'] = 'Present';
$string['notelabel'] = 'Note';
$string['attendancelabel'] = 'Attendance';
$string['historylabel'] = 'History';
$string['attendancesubmit'] = 'Submit';
$string['presentswitch'] = 'Present';
$string['absentswitch'] = 'Absent';
$string['sucessfulalert'] = 'Sucessfully';
$string['finalgradelabel'] = 'Final grade';
$string['statuscourse'] = 'Learning status';
$string['registercourse'] = 'Register';
$string['statuscourse'] = 'Learning status';
$string['registerfail'] = 'Register fail';
$string['courseoutlinelabel'] = 'Course outline';

// Self enroll screen
$string['enrol_noti'] = 'Enrol course';
$string['suggest_noti'] = 'Suggest course';
$string['quiz_start_noti'] = 'Quiz start';
$string['quiz_end_noti'] = 'Quiz end';
$string['quiz_completed_noti'] = 'Submit quiz successful';
$string['remind_login_noti'] = 'Remind login';
$string['remind_expire_required_course_noti'] = 'Certificate required course expire soon';
$string['remind_education_schedule_noti'] = 'Remind education schedule';
$string['remind_access_course_noti'] = 'Remind access course';
$string['remind_upcoming_course_noti'] = 'Remind upcoming course';
$string['remind_certificate_noti'] = 'Remind certificate';

// Participants screen
$string['indexlabel'] = 'Index';
$string['eventcodelabel'] = 'Event code';
$string['eventnamelabel'] = 'Event name';
$string['eventlabel'] = 'Event';
$string['usermodifiedlabel'] = 'User modified';
$string['contentlabel'] = 'Content';
$string['timemodifiedlabel'] = 'Time modified';
$string['numberofparticipants'] = 'Number of participants: ';
$string['firstbutton'] = 'First';
$string['lastbutton'] = 'Last';
...
$string['surveycourse'] = 'Survey questionnaire for course';

$string['cvkdtitle'] = 'Saleman guideline';

$string['importquestionlabel'] = 'Import questions from file';
$string['importquestionselect'] = 'Select image to upload:';
