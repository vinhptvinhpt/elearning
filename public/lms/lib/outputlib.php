...
class theme_config {
     ...
     */
    public function layout_file($pagelayout,$pagetype) {
        global $CFG;

        // VinhPT
        // Config custom file pagelayout to parameter layout_info_for_page
        if ($pagelayout == "admin" && $pagetype == "course-edit"){
            $pagelayout = "course_edit";
        }
        //if ($pagelayout == "frontpage" && $pagetype == "site-index"){
        //    $pagelayout = "course_edit";
        //}
        if ($pagelayout == "admin" && $pagetype == "course-management"){
            $pagelayout = "course_edit";
        }
