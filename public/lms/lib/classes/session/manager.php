...
class manager {
    ...
    protected static function prepare_cookies() {
		...
		session_set_cookie_params($CFG->sessiontimeout, $CFG->sessioncookiepath, $CFG->sessioncookiedomain, $cookiesecure, $CFG->cookiehttponly);ini_set('session.use_trans_sid', '0');
