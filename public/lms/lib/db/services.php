...
$functions = array(
   ...
   'core_backup_get_async_backup_links_restore' => array(
    ...
    // [VinhPT]
    // Get enrolled soft skill courses
    'core_course_get_enrolled_courses_softskill' => array(
        'classname' => 'core_course_external',
        'methodname' => 'get_enrolled_courses_softskill',
        'classpath' => 'course/externallib.php',
        'description' => 'List of enrolled courses for the given timeline classification (past, inprogress, or future).',
        'type' => 'read',
        'ajax' => true,
    ...
    // [VinhPT]
    // Get enrolled certificate courses
    'core_course_get_enrolled_courses_certificate' => array(
        'classname' => 'core_course_external',
        'methodname' => 'get_enrolled_courses_certificate',
        'classpath' => 'course/externallib.php',
        'description' => 'List of enrolled courses for the given timeline classification (past, inprogress, or future).',
        'type' => 'read',
        'ajax' => true,
    ...
    // [VinhPT]
    // Get enrolled offline courses
    'core_course_get_enrolled_courses_offline' => array(
        'classname' => 'core_course_external',
        'methodname' => 'get_enrolled_courses_offline',
        'classpath' => 'course/externallib.php',
        'description' => 'List of enrolled courses for the given timeline classification (past, inprogress, or future).',
        'type' => 'read',
        'ajax' => true,
    ...
    // [VinhPT]
    // Add definition for core_course_get_certificate_courses
    'core_course_get_certificate_courses' => array(
        'classname' => 'core_course_external',
        'methodname' => 'get_certificate_courses',
        'classpath' => 'course/externallib.php',
        'description' => 'List of certificate courses .',
        'type' => 'read',
        'ajax' => true,
        'services' => array(MOODLE_OFFICIAL_MOBILE_SERVICE),
    ),
