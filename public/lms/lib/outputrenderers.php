...
//       $output .= '<meta name="sso_smsc_apikey" content="bd629ce2de47436e3a9cdd2673e97b17" />';
//        $output .= '<script src="/template/assets/node_modules/jquery/jquery-3.2.1.min.js"></script>';
        // $output .= '<script src="/sso/sslssso.js"></script>';
        $output .= '<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />' . "\n";
        $output .= '<meta name="keywords" content="moodle, ' . $this->page->title . '" />' . "\n";
        // $ajax_login = "/lms/login/index.php";
        // //$ajax_login = "$CFG->wwwroot/login/index.php";
        // $redirect_logout = "//bgt.tinhvan.com/";
        // $output .= <<<SSO
        // <script>
            ...
            // function onLogout() {
                ...
                // $.ajax({
                        ...
                        // dataType: 'json',
                        // success: function(data) {
                            // if(data == 1 && window.location.href != '{$ajax_login}'){
...
// SSO;
    ...
    public function header()
    {
        ...
        // VinhPT
        // Add page type to choose layout_file
        // Find the appropriate page layout file, based on $this->page->pagelayout.
        $layoutfile = $this->page->theme->layout_file($this->page->pagelayout, $this->page->pagetype);
    ...
    protected function render_user_picture(user_picture $userpicture) {
        ...
        // [VinhPT]
        $user_picture_url = "select avatar from tms_user_detail  where user_id=" . $user->id;
        $url_picture = array_values($DB->get_records_sql($user_picture_url))[0]->avatar;
...
//        }
            ...
            foreach ($opts->navitems as $key => $value) {
                ...
                switch ($value->itemtype) {
                    ...
                    case 'link':
                        ...
                        // Add ssologout
                        if ($key == '5') {
                            $al->attributes['onclick'] = "logoutClick();";
                        }
                        $am->add($al);
                        break;
                }
    ...
    protected function build_action_menu_from_navigation(action_menu $menu,
        ...
        $hidden_node = array('editsettings', 'backup', 'restore', 'reset', 'gradebooksetup');
        $skipped = false;
        // Build an action menu based on the visible nodes from this navigation tree.
        foreach ($node->children as $menuitem) {
            if ($menuitem->display) {
                ...
                // [VinhPT] Edit the admin setting in course
                if ($node->key == 'courseadmin' && in_array($menuitem->key, $hidden_node)){
                }else{
                    $menu->add_secondary_action($link);
                }
