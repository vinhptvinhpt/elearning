...
$string['attemptnumber'] = 'Lần tham gia';
...
$string['attemptsnum'] = 'Lần tham gia: {$a}';
...
$string['attemptsunlimited'] = 'Không giới hạn lần tham gia';
...
$string['endtest'] = 'Hoàn thành bài thi ...';
...
$string['finishattemptdots'] = 'Kết thúc...';
...
$string['grademethod'] = 'Các tính điểm';
...
$string['mustbesubmittedby'] = 'Bài thi sẽ đóng lúc {$a}.';
$string['name'] = 'Name';
...
$string['quiznavigation'] = 'Bảng điều hướng';
...
$string['quizopenedon'] = 'Bài kiểm tra sẽ được mở vào {$a}';
...
$string['returnattempt'] = 'Tiếp tục bài thi';
...
$string['startattempt'] = 'Bắt đầu';
$string['startedon'] = 'Started on';
$string['startnewpreview'] = 'Start a new preview';
$string['stateabandoned'] = 'Never submitted';
$string['statefinished'] = 'Hoàn thành';
$string['statefinisheddetails'] = 'Hoàn thành lúc {$a}';
...
$string['summaryofattempt'] = 'Tổng hợp kết quả';
$string['summaryofattempts'] = 'Tổng hợp kết quả';
