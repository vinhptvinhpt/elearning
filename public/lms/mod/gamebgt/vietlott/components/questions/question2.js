export default {
    template: `<div class="screens">
        ...
        <button @click="screenIndex++" style="width: 200px; height: 40px; left: 220px; top: 160px; background-color: #c2c7d1; font-weight: bold;">
        ...
        <label style="text-align: center; width: 640px; left: 0; top: 0px; font-size: 22px;">MEGA 6/45 Tự Chọn</label>
        ...
        <div id="popup_ticket" class="modal">
          ...
          <div class="modal-content">
            ...
            <img src="./images/Ticket_game/01.png" width="400" height="400" style="margin-left: auto; margin-right: auto;">
          </div>
        </div>
        <!-- End Ticket result -->
        ...
        <input v-model="screenData[1].input3.value" class="mega-input" type="text" style="top: 185px; left: 45px; height: 20px; width: 140px; background: none; border: 1px solid #000;" readonly>
        ...
        <label style="top: 48px; left: 430px; font-size: 12px; top: 133px; left: 265px;">Số Bảng</label>
        <input @click="screenData[1].focusModel = 'input1'" v-model="screenData[1].input1.value" :class="{focus: screenData[1].focusModel === 'input1'}" class="mega-input" type="text" style="top: 130px; left: 340px; height: 24px; width: 60px;" readonly>
        <label style="top: 48px; left: 430px; font-size: 12px; top: 163px; left: 265px;">Tổng Cộng</label>
        <input id="total_price" class="mega-input" type="text" style="top: 160px; left: 330px; height: 24px; width: 236px;" :value="$parent.$options.methods.formatPrice(summary)" readonly>
        
        <button @click="append('9')" style="width: 100px; height: 35px; font-size: 20px; position: absolute; top: 195px; left: 470px;">9
        </button>
        <button @click="append('8')" style="width: 100px; height: 35px; font-size: 20px; position: absolute; top: 195px; left: 370px;">8
        </button>
        <button @click="append('7')" style="width: 100px; height: 35px; font-size: 20px; position: absolute; top: 195px; left: 270px;">7</button>

        <button @click="append('6')" style="width: 100px; height: 35px; font-size: 20px; position: absolute; top: 230px; left: 470px;">6
        </button>
        <button @click="append('5')" style="width: 100px; height: 35px; font-size: 20px; position: absolute; top: 230px; left: 370px;">5
        </button>
        <button @click="append('4')" style="width: 100px; height: 35px; font-size: 20px; position: absolute; top: 230px; left: 270px;">4
        </button>

        <button @click="append('3')" style="width: 100px; height: 35px; font-size: 20px; position: absolute; top: 265px; left: 470px;">3
        </button>
        <button @click="append('2')" style="width: 100px; height: 35px; font-size: 20px; position: absolute; top: 265px; left: 370px;">2
        </button>
        <button @click="append('1')" style="width: 100px; height: 35px; font-size: 20px; position: absolute; top: 265px; left: 270px;">1
        </button>

        <button @click="append('0')" style="width: 100px; height: 35px; font-size: 20px; position: absolute; top: 300px; left: 370px;">0
        </button>
        <button @click="backspace" style="width: 100px; height: 35px; font-size: 12px; position: absolute; top: 300px; left: 270px;"><--
        </button>
        ...
        <button :disabled="screenData[1].input1.value.length < 1" @click="submit" class="submit-button" style="width: 154px; height: 40px; left: 163px; top: 390px; text-transform: uppercase; font-size: 14px;">Gửi</button>
    ...
    computed: {
        summary: function () {
            ...
            return price * (parseInt(this.screenData[1].radio.value) || 0) * (parseInt(this.screenData[1].input1.value) || 0);
        }
    },
    mounted: function () {
    ...
    methods: {
        ...
        submit: function () {
            if (this.screenData[1].radio.value.toString() === "2"
                && this.screenData[1].input1.value.toString() === "3"
            ) {
