export default {
    template: `<div class="screens">
        ...
        <div id="popup_ticket" class="modal">
          ...
          <div class="modal-content">
            ...
            <img src="./images/Ticket_game/12.png" width="400" height="400" style="margin-left: auto; margin-right: auto;">
          </div>
        </div>
        <!-- End Ticket result -->
    ...
    methods: {
        ...
        submit: function () {
            if (
                this.screenData[1].input1.value.toString() === "5569"
                && this.screenData[1].input2.value.toString() === "20000"
                && this.screenData[1].input3.value.toString() === "BAO"
