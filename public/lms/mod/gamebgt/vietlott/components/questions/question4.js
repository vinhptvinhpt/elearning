export default {
    template: `<div class="screens">
        ...
        <button @click="screenIndex++" style="width: 200px; height: 40px; left: 10px; top: 205px; background-color: #fd624e; font-weight: bold;">
        ...
        <label style="text-align: center; width: 640px; left: 0; top: 0px; font-size: 22px;">POWER 6/55</label>
        ...
        <div id="popup_ticket" class="modal">
          ...
          <div class="modal-content">
            ...
            <img src="./images/Ticket_game/03.png" width="400" height="400" style="margin-left: auto; margin-right: auto;">
          </div>
        </div>
        <!-- End Ticket result -->

        <div style="width: 640px; height: 350px; top: 35px; left: 0; background-color: #da4829;"></div> 
        ...
        <input v-model="screenData[1].input3.value" class="power-input" type="text" style="top: 185px; left: 45px; height: 20px; width: 140px; background: none; border: 1px solid #000;" readonly>
        ...
        <button @click="screenIndex = 3" style="width: 186px; height: 56px; top: 328px; left: 1px;">BAO KHÁC</button>

        <div style="background-color: #fff; width: 190px; height: 264px; top: 40px; left: 200px; border: 2px solid #782c37;">
            <div class="row no-gutters numbers" style="font-size: 12px;">
                <div class="col-2 text-center"><a :class="{ selected: isExists(1) }" @click="add(1)">1</a></div>
                <div class="col-2 text-center"><a :class="{ selected: isExists(11) }" @click="add(11)">11</a></div>
                <div class="col-2 text-center"><a :class="{ selected: isExists(21) }" @click="add(21)">21</a></div>
                <div class="col-2 text-center"><a :class="{ selected: isExists(31) }" @click="add(31)">31</a></div>
                <div class="col-2 text-center"><a :class="{ selected: isExists(41) }" @click="add(41)">41</a></div>
                <div class="col-2 text-center"><a :class="{ selected: isExists(51) }" @click="add(51)">51</a></div>
                
                <div class="col-2 text-center"><a :class="{ selected: isExists(2) }" @click="add(2)">2</a></div>
                <div class="col-2 text-center"><a :class="{ selected: isExists(12) }" @click="add(12)">12</a></div>
                <div class="col-2 text-center"><a :class="{ selected: isExists(22) }" @click="add(22)">22</a></div>
                <div class="col-2 text-center"><a :class="{ selected: isExists(32) }" @click="add(32)">32</a></div>
                <div class="col-2 text-center"><a :class="{ selected: isExists(42) }" @click="add(42)">42</a></div>
                <div class="col-2 text-center"><a :class="{ selected: isExists(52) }" @click="add(52)">52</a></div>
                
                <div class="col-2 text-center"><a :class="{ selected: isExists(3) }" @click="add(3)">3</a></div>
                <div class="col-2 text-center"><a :class="{ selected: isExists(13) }" @click="add(13)">13</a></div>
                <div class="col-2 text-center"><a :class="{ selected: isExists(23) }" @click="add(23)">23</a></div>
                <div class="col-2 text-center"><a :class="{ selected: isExists(33) }" @click="add(33)">33</a></div>
                <div class="col-2 text-center"><a :class="{ selected: isExists(43) }" @click="add(43)">43</a></div>
                <div class="col-2 text-center"><a :class="{ selected: isExists(53) }" @click="add(53)">53</a></div>
                
                <div class="col-2 text-center"><a :class="{ selected: isExists(4) }" @click="add(4)">4</a></div>
                <div class="col-2 text-center"><a :class="{ selected: isExists(14) }" @click="add(14)">14</a></div>
                <div class="col-2 text-center"><a :class="{ selected: isExists(24) }" @click="add(24)">24</a></div>
                <div class="col-2 text-center"><a :class="{ selected: isExists(34) }" @click="add(34)">34</a></div>
                <div class="col-2 text-center"><a :class="{ selected: isExists(44) }" @click="add(44)">44</a></div>
                <div class="col-2 text-center"><a :class="{ selected: isExists(54) }" @click="add(54)">54</a></div>
                
                <div class="col-2 text-center"><a :class="{ selected: isExists(5) }" @click="add(5)">5</a></div>
                <div class="col-2 text-center"><a :class="{ selected: isExists(15) }" @click="add(15)">15</a></div>
                <div class="col-2 text-center"><a :class="{ selected: isExists(25) }" @click="add(25)">25</a></div>
                <div class="col-2 text-center"><a :class="{ selected: isExists(35) }" @click="add(35)">35</a></div>
                <div class="col-2 text-center"><a :class="{ selected: isExists(45) }" @click="add(45)">45</a></div>
                <div class="col-2 text-center"><a :class="{ selected: isExists(55) }" @click="add(55)">55</a></div>
                
                <div class="col-2 text-center"><a :class="{ selected: isExists(6) }" @click="add(6)">6</a></div>
                <div class="col-2 text-center"><a :class="{ selected: isExists(16) }" @click="add(16)">16</a></div>
                <div class="col-2 text-center"><a :class="{ selected: isExists(26) }" @click="add(26)">26</a></div>
                <div class="col-2 text-center"><a :class="{ selected: isExists(36) }" @click="add(36)">36</a></div>
                <div class="col-2 text-center"><a :class="{ selected: isExists(46) }" @click="add(46)">46</a></div>
                <div class="col-2 text-center empty"></div>
                
                <div class="col-2 text-center"><a :class="{ selected: isExists(7) }" @click="add(7)">7</a></div>
                <div class="col-2 text-center"><a :class="{ selected: isExists(17) }" @click="add(17)">17</a></div>
                <div class="col-2 text-center"><a :class="{ selected: isExists(27) }" @click="add(27)">27</a></div>
                <div class="col-2 text-center"><a :class="{ selected: isExists(37) }" @click="add(37)">37</a></div>
                <div class="col-2 text-center"><a :class="{ selected: isExists(47) }" @click="add(47)">47</a></div>
                <div class="col-2 text-center empty"></div>
                
                <div class="col-2 text-center"><a :class="{ selected: isExists(8) }" @click="add(8)">8</a></div>
                <div class="col-2 text-center"><a :class="{ selected: isExists(18) }" @click="add(18)">18</a></div>
                <div class="col-2 text-center"><a :class="{ selected: isExists(28) }" @click="add(28)">28</a></div>
                <div class="col-2 text-center"><a :class="{ selected: isExists(38) }" @click="add(38)">38</a></div>
                <div class="col-2 text-center"><a :class="{ selected: isExists(48) }" @click="add(48)">48</a></div>
                <div class="col-2 text-center empty"></div>
                
                <div class="col-2 text-center"><a :class="{ selected: isExists(9) }" @click="add(9)">9</a></div>
                <div class="col-2 text-center"><a :class="{ selected: isExists(19) }" @click="add(19)">19</a></div>
                <div class="col-2 text-center"><a :class="{ selected: isExists(29) }" @click="add(29)">29</a></div>
                <div class="col-2 text-center"><a :class="{ selected: isExists(39) }" @click="add(39)">39</a></div>
                <div class="col-2 text-center"><a :class="{ selected: isExists(49) }" @click="add(49)">49</a></div>
                <div class="col-2 text-center empty"></div>
                
                <div class="col-2 text-center"><a :class="{ selected: isExists(10) }" @click="add(10)">10</a></div>
                <div class="col-2 text-center"><a :class="{ selected: isExists(20) }" @click="add(20)">20</a></div>
                <div class="col-2 text-center"><a :class="{ selected: isExists(30) }" @click="add(30)">30</a></div>
                <div class="col-2 text-center"><a :class="{ selected: isExists(40) }" @click="add(40)">40</a></div>
                <div class="col-2 text-center"><a :class="{ selected: isExists(50) }" @click="add(50)">50</a></div>
                <div class="col-2 text-center empty"></div>
            </div>
        </div>

        <label style="top: 90px; left: 450px; font-size: 14px;">A</label>
        <textarea @click="screenData[1].focusModel = 'input1'" :value="value('input1')" :class="{focus: screenData[1].focusModel === 'input1'}" class="power-input" type="text" style="top: 76px; left: 474px; height: 48px; width: 164px; padding-right: 70px;"readonly></textarea>
        
        <label style="top: 141px; left: 450px; font-size: 14px;">B</label>
        <textarea @click="screenData[1].focusModel = 'input2'" :value="value('input2')" :class="{focus: screenData[1].focusModel === 'input2'}" class="power-input" type="text" style="top: 127px; left: 474px; height: 48px; width: 164px; padding-right: 70px;" readonly></textarea>
         
        <label style="top: 192px; left: 450px; font-size: 14px;">C</label>
        <textarea @click="screenData[1].focusModel = 'input4'" :value="value('input4')" :class="{focus: screenData[1].focusModel === 'input4'}" class="power-input" type="text" style="top: 178px; left: 474px; height: 48px; width: 164px; padding-right: 70px;" readonly></textarea>
         
        <label style="top: 243px; left: 450px; font-size: 14px;">D</label>
        <textarea @click="screenData[1].focusModel = 'input5'" :value="value('input5')" :class="{focus: screenData[1].focusModel === 'input5'}" class="power-input" type="text" style="top: 229px; left: 474px; height: 48px; width: 164px; padding-right: 70px;" readonly></textarea>
         
        <label style="top: 294px; left: 450px; font-size: 14px;">E</label>
        <textarea @click="screenData[1].focusModel = 'input6'" :value="value('input6')" :class="{focus: screenData[1].focusModel === 'input6'}" class="power-input" type="text" style="top: 280px; left: 474px; height: 48px; width: 164px; padding-right: 70px;" readonly></textarea>
         
        <label style="top: 345px; left: 450px; font-size: 14px;">F</label>
        <textarea @click="screenData[1].focusModel = 'input7'" :value="value('input7')" :class="{focus: screenData[1].focusModel === 'input7'}" class="power-input" type="text" style="top: 331px; left: 474px; height: 48px; width: 164px; padding-right: 70px;" readonly></textarea>
          
        <label style="top: 48px; left: 430px; font-size: 12px;">Tổng Cộng</label>
        <input class="power-input" type="text" style="top: 35px; left: 500px; height: 40px; width: 130px;" :value="$parent.$options.methods.formatPrice(summary)" readonly>
        ...
        <div class="screen" :class="{ active: screenIndex === 2 }">
          <label style="text-align: center; width: 640px; position: absolute; left: 0; top: 0; font-size: 22px;">POWER 6/55 Bao</label> 
        ...
        <div class="screen" :class="{ active: screenIndex === 3 }">
            <label style="text-align: center; width: 640px; left: 0; top: 0; font-size: 22px;">Bao</label>
            <div style="width: 640px; height: 350px; top: 35px; left: 0; background-color: #da4829;"></div>

            <button @click="$emit('event','error')" style="width: 207px; height: 81px; top: 38px; left: 3px;">BAO 5R</button>
            <button @click="$emit('event','error')" style="width: 207px; height: 81px; top: 38px; left: 216px;">BAO 7</button>
            <button @click="$emit('event','error')" style="width: 207px; height: 81px; top: 38px; left: 429px;">BAO 8</button>
            
            <button @click="$emit('event','error')" style="width: 207px; height: 81px; top: 125px; left: 3px;">BAO 9</button>
            <button @click="$emit('event','error')" style="width: 207px; height: 81px; top: 125px; left: 216px; background-color: #000; color:#fff;">[A] BAO 10</button>
            <button @click="$emit('event','error')" style="width: 207px; height: 81px; top: 125px; left: 429px; background-color: #000; color:#fff;">[B] BAO 11</button>
            
            <button @click="$emit('event','error')" style="width: 207px; height: 81px; top: 212px; left: 3px; background-color: #000; color:#fff;">[C] BAO 12</button>
            <button @click="$emit('event','error')" style="width: 207px; height: 81px; top: 212px; left: 216px; background-color: #000; color:#fff;">[D] BAO 13</button>
            <button @click="$emit('event','error')" style="width: 207px; height: 81px; top: 212px; left: 429px; background-color: #000; color:#fff;">[E] BAO 14</button>
            
            <button @click="$emit('event','error')" style="width: 207px; height: 81px; top: 299px; left: 3px; background-color: #000; color:#fff;">[F] BAO 15</button>
            <button @click="screenData[1].input3.value = 'BAO 18'; screenIndex = 1" style="width: 207px; height: 81px; top: 299px; left: 216px;">[1] BAO 18</button>
             
            <button @click="screenIndex = 1" style="width: 154px; height: 40px; left: 3px; top: 390px; background-color: rgb(191, 191, 191); text-transform: uppercase; font-size: 20px;">Thoát</button>
            <button @click="$emit('event','error')" style="left: 69px; top: 439px; width: 60px; height: 35px;"><img src="images/hotspot_ico.png" width="32px"></button>
            <button @click="$emit('event','error')" style="left: 132px; top: 439px; width: 60px; height: 35px;"><img src="images/arrow_up_ico.png" width="32px"></button>
            <button @click="$emit('event','error')" style="left: 195px; top: 439px; width: 60px; height: 35px;"><img src="images/printer_ico.png" width="32px"></button>
            <button @click="$emit('event','error')" style="left: 258px; top: 439px; width: 60px; height: 35px;"><img src="images/printer_2_ico.png" width="32px"></button>
    ...
    methods: {
        ...
        submit: function () {
            if (
                this.screenData[1].input1.value.toString() === "2,9,11,14,17,19,22,25,29,31,35,40,43,48,49,50,52,55"
                && this.screenData[1].input3.value.toString() === "BAO 18"
