export default {
    template: `<div class="screens">
        ...
        <button @click="screenIndex++" style="width: 200px; height: 40px; left: 220px; top: 295px; background-color: #c2c7d1; font-weight: bold;">
        ...
        <div id="popup_ticket" class="modal">
          ...
          <div class="modal-content">
            ...
            <img src="./images/Ticket_game/16.png" width="400" height="400" style="margin-left: auto; margin-right: auto;">
          </div>
        </div>
        <!-- End Ticket result -->
    ...
    computed: {
        ...
        validate: function () {
            var validated = false;
            if (this.screenData[1].input1.value.length > 0 && (parseInt(this.screenData[1].input2.value) || 0) >= 10000) validated = true;
            return validated;
        }
    },
    methods: {
        set: function (value) {
            if (['input2'].includes(this.screenData[this.screenIndex].focusModel)) {
        ...
        submit: function () {
            if (
                this.screenData[1].input1.value.toString() === "4"
                && this.screenData[1].input2.value.toString() === "10000"
