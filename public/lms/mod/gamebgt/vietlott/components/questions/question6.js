export default {
    template: `<div class="screens">
        ...
        <div id="popup_ticket" class="modal">
          ...
          <div class="modal-content">
            ...
            <img src="./images/Ticket_game/05.png" width="400" height="400" style="margin-left: auto; margin-right: auto;">
          </div>
        </div>
        <!-- End Ticket result --> 
    ...
    methods: {
        ...
        submit: function () {
            if (
                this.screenData[1].input1.value.toString() === "3579"
                && this.screenData[1].input2.value.toString() === "30000"
                && this.screenData[1].input4.value.toString() === "2222"
                && this.screenData[1].input5.value.toString() === "100000"
                && this.screenData[1].input6.value.toString() === "8888"
                && this.screenData[1].input7.value.toString() === "200000"
