export default {
    template: `<div class="screens">
        ...
        <button @click="screenIndex = 2" style="width: 200px; height: 40px; left: 10px; top: 295px; background-color: #fb7ae0; font-weight: bold;">
            <span>MAX 3D</span><img src="images/3d_ico.png" width="32px">
        </button>
        <button @click="screenIndex = 1" style="width: 200px; height: 40px; left: 220px; top: 295px; background-color: #c2c7d1; font-weight: bold;">
        ...
        <label style="text-align: center; width: 640px; left: 0; top: 0px; font-size: 22px;">3D Tự Chọn</label>
        ...
        <div id="popup_ticket" class="modal">
          ...
          <div class="modal-content">
            ...
            <img src="./images/Ticket_game/15.png" width="400" height="400" style="margin-left: auto; margin-right: auto;">
          </div>
        </div>
        <!-- End Ticket result -->

        <div style="width: 640px; height: 350px; top: 35px; left: 0; background-color: #bd1192;"></div> 
       ...
       <label class="custom-control custom-checkbox" style="left: 5px; top: 35px;">
        ...
        <input v-model="screenData[1].input3.value" class="three-d-input" type="text" style="top: 185px; left: 45px; height: 20px; width: 140px;" readonly>
       <button class="mode-btn" :class="{active:screenData[1].input3.value === '3D'}" :disabled="!modeChangeable" @click="screenData[1].input3.value = '3D'" style="font-size: 20px; width: 92px; height: 100px; top: 210px; left: 1px;">3D</button>
        <button class="mode-btn" :class="{active:screenData[1].input3.value === '3D+'}" :disabled="!modeChangeable" @click="screenData[1].input3.value = '3D+'" style="font-size: 20px; width: 92px; height: 100px; top: 210px; left: 95px;">3D+</button>
         
        <label style="top: 118px; left: 260px; font-size: 14px;">Số Bảng</label>
        <input @click="screenData[1].focusModel = 'input1'" v-model="screenData[1].input1.value" :class="{focus: screenData[1].focusModel === 'input1'}" class="three-d-input" type="text" style="top: 118px; left: 340px; height: 24px; width: 60px;" readonly>
        <label style="top: 150px; left: 220px; font-size: 14px;">Số Tiền</label>
        <input @click="screenData[1].focusModel = 'input2'" v-model="screenData[1].input2.value" :class="{focus: screenData[1].focusModel === 'input2'}" class="three-d-input" type="text" style="top: 150px; left: 275px; height: 24px; width: 125px;" readonly>
        <label style="top: 182px; left: 200px; font-size: 14px;">Tổng Cộng</label>
        <input class="three-d-input" type="text" style="top: 182px; left: 275px; height: 24px; width: 125px;" :value="$parent.$options.methods.formatPrice(summary)" readonly>
        ...
        <label style="text-align: center; width: 640px; left: 0; top: 0px; font-size: 22px;">MAX 3D</label>
         
        <div style="width: 640px; height: 350px; top: 35px; left: 0; background-color: #bd1192;"></div> 
        
        <label class="custom-control custom-checkbox" style="left: 5px; top: 35px;">
           <input class="custom-control-input" type="radio" v-model="screenData[2].radio.value" value="1">
           <span class="custom-control-indicator"></span>
           <span class="custom-control-description">1 Kỳ Quay Số</span>
        </label>
        
        <label class="custom-control custom-checkbox" style="left: 5px; top: 60px;">
           <input class="custom-control-input" type="radio" v-model="screenData[2].radio.value" value="2">
           <span class="custom-control-indicator"></span>
           <span class="custom-control-description">2 Kỳ Quay Số</span>
        </label>
        
        <label class="custom-control custom-checkbox" style="left: 5px; top: 85px;">
           <input class="custom-control-input" type="radio" v-model="screenData[2].radio.value" value="3">
           <span class="custom-control-indicator"></span>
           <span class="custom-control-description">3 Kỳ Quay Số</span>
        </label>
        
        <label class="custom-control custom-checkbox" style="left: 5px; top: 110px;">
           <input class="custom-control-input" type="radio" v-model="screenData[2].radio.value" value="4">
           <span class="custom-control-indicator"></span>
           <span class="custom-control-description">4 Kỳ Quay Số</span>
        </label>
        
        <label class="custom-control custom-checkbox" style="left: 5px; top: 135px;">
           <input class="custom-control-input" type="radio" v-model="screenData[2].radio.value" value="5">
           <span class="custom-control-indicator"></span>
           <span class="custom-control-description">5 Kỳ Quay Số</span>
        </label>
        
        <label class="custom-control custom-checkbox" style="left: 5px; top: 160px;">
           <input class="custom-control-input" type="radio" v-model="screenData[2].radio.value" value="6">
           <span class="custom-control-indicator"></span>
           <span class="custom-control-description">6 Kỳ Quay Số</span>
        </label>
        
        <label class="custom-control custom-checkbox" style="left: 105px; top: 35px;">
           <input class="custom-control-input" type="radio" v-model="screenData[2].radio.value" value="A">
           <span class="custom-control-indicator"></span>
           <span class="custom-control-description">[A] 08/09/19</span>
        </label>   
        
        <label class="custom-control custom-checkbox" style="left: 105px; top: 60px;">
           <input class="custom-control-input" type="radio" v-model="screenData[2].radio.value" value="B">
           <span class="custom-control-indicator"></span>
           <span class="custom-control-description">[B] 10/09/19</span>
        </label>
        
        <label class="custom-control custom-checkbox" style="left: 105px; top: 85px;">
           <input class="custom-control-input" type="radio" v-model="screenData[2].radio.value" value="C">
           <span class="custom-control-indicator"></span>
           <span class="custom-control-description">[C] 13/09/19</span>
        </label>
        
        <label class="custom-control custom-checkbox" style="left: 105px; top: 110px;">
           <input class="custom-control-input" type="radio" v-model="screenData[2].radio.value" value="D">
           <span class="custom-control-indicator"></span>
           <span class="custom-control-description">[D] 16/09/19</span>
        </label>
        
        <label class="custom-control custom-checkbox" style="left: 105px; top: 135px;">
           <input class="custom-control-input" type="radio" v-model="screenData[2].radio.value" value="E">
           <span class="custom-control-indicator"></span>
           <span class="custom-control-description">[E] 20/09/19</span>
        </label>
        
        <label class="custom-control custom-checkbox" style="left: 105px; top: 160px;">
           <input class="custom-control-input" type="radio" v-model="screenData[2].radio.value" value="F">
           <span class="custom-control-indicator"></span>
           <span class="custom-control-description">[F] 26/09/19</span>
        </label>                      
         
        <label style="top: 185px; left: 3px; font-size: 14px;">Chơi</label>
        <input v-model="screenData[2].input3.value" class="three-d-input" type="text" style="top: 185px; left: 45px; height: 20px; width: 140px;" readonly>
        <button class="mode-btn" :class="{active:screenData[2].input3.value === '3D'}" :disabled="!modeChangeable" @click="screenData[2].input3.value = '3D'" style="font-size: 20px; width: 92px; height: 100px; top: 210px; left: 1px;">3D</button>
        <button class="mode-btn" :class="{active:screenData[2].input3.value === '3D+'}" :disabled="!modeChangeable" @click="screenData[2].input3.value = '3D+'" style="font-size: 20px; width: 92px; height: 100px; top: 210px; left: 95px;">3D+</button>
         
        <label style="top: 40px; left: 215px; font-size: 14px;">MAX 3D</label>
        <label style="top: 40px; left: 310px; font-size: 14px;">Số Tiền</label>
        <label style="top: 88px; left: 200px; font-size: 14px;">A</label>
        <input @click="screenData[2].focusModel = 'input1'" v-model="screenData[2].input1.value" :class="{focus: screenData[2].focusModel === 'input1'}" class="three-d-input" type="text" style="top: 65px; left: 215px; height: 65px; width: 82px;" readonly>
        <input @click="screenData[2].focusModel = 'input2'" v-model="screenData[2].input2.value" :class="{focus: screenData[2].focusModel === 'input2'}" class="three-d-input" type="text" style="top: 65px; left: 300px; height: 65px; width: 82px;" readonly> 
         
        <label style="top: 153px; left: 200px; font-size: 14px;">B</label>
        <input @click="screenData[2].focusModel = 'input4'" v-model="screenData[2].input4.value" :class="{focus: screenData[2].focusModel === 'input4'}" class="three-d-input" type="text" style="top: 130px; left: 215px; height: 65px; width: 82px;" readonly>
        <input @click="screenData[2].focusModel = 'input5'" v-model="screenData[2].input5.value" :class="{focus: screenData[2].focusModel === 'input5'}" class="three-d-input" type="text" style="top: 130px; left: 300px; height: 65px; width: 82px;" readonly>  
         
        <label style="top: 218px; left: 200px; font-size: 14px;">C</label>
        <input @click="screenData[2].focusModel = 'input6'" v-model="screenData[2].input6.value" :class="{focus: screenData[2].focusModel === 'input6'}" class="three-d-input" type="text" style="top: 195px; left: 215px; height: 65px; width: 82px;" readonly>
        <input @click="screenData[2].focusModel = 'input7'" v-model="screenData[2].input7.value" :class="{focus: screenData[2].focusModel === 'input7'}" class="three-d-input" type="text" style="top: 195px; left: 300px; height: 65px; width: 82px;" readonly>  
         
        <label style="top: 283px; left: 200px; font-size: 14px;">D</label>
        <input @click="screenData[2].focusModel = 'input8'" v-model="screenData[2].input8.value" :class="{focus: screenData[2].focusModel === 'input8'}" class="three-d-input" type="text" style="top: 260px; left: 215px; height: 65px; width: 82px;" readonly>
        <input @click="screenData[2].focusModel = 'input9'" v-model="screenData[2].input9.value" :class="{focus: screenData[2].focusModel === 'input9'}" class="three-d-input" type="text" style="top: 260px; left: 300px; height: 65px; width: 82px;" readonly>  
          
        <label style="top: 38px; left: 390px; font-size: 12px;">Tổng Cộng</label>
        <input class="three-d-input" type="text" style="top: 35px; left: 460px; height: 24px; width: 175px;" :value="$parent.$options.methods.formatPrice(summary)" readonly>
        ...
        return {
            screenData: [
                ...
                },
                {
                    ...
                    radio: {value: 1},
                    input3: {value: ""},
                    input1: {value: "", limit: 3, link: 'input2'},
                    input2: {value: ""},
                    input4: {value: "", limit: 3, link: 'input5'},
                    input5: {value: ""},
                    input6: {value: "", limit: 3, link: 'input7'},
                    input7: {value: ""},
                    input8: {value: "", limit: 3, link: 'input9'},
                    input9: {value: ""},
                }
            ],
            initialData: [],
    ...
    computed: {
        mode: function () {
           return this.screenData[this.screenIndex].input3.value;
        },
        summary: function () {
            if (this.screenIndex === 1)
                return (parseInt(this.screenData[1].radio.value) || 0) * (parseInt(this.screenData[1].input1.value) || 0) * (parseInt(this.screenData[1].input2.value) || 0);
            else if (this.screenIndex === 2) {
                var a = 0, b = ['input2', 'input5', 'input7', 'input9'];
                for (var i = 0; i < b.length; i++) {
                    a += (parseInt(this.screenData[2][b[i]].value) || 0);
                }
                return a * (parseInt(this.screenData[2].radio.value) || 0);
            } else return 0;
        },
        modeChangeable: function () {
            var a = true, b = ['input1', 'input4', 'input6', 'input8'];
            if (this.screenIndex === 2) {
                for (var i = 0; i < b.length; i++) {
                    var model = this.screenData[2][b[i]];
        ...
        validate: function () {
            var validated = false;
            if (this.screenIndex === 1 && this.screenData[1].input1.value.length > 0 && (parseInt(this.screenData[1].input2.value) || 0) >= 10000) validated = true;
            else if (this.screenIndex === 2) {
                var b = ['input1', 'input4', 'input6', 'input8'];
                var c = 3;
                for (var i = 0; i < b.length; i++) {
                    var model = this.screenData[this.screenIndex][b[i]];
                    if (model.value === 'TC' || model.value.length === c) {
                        if ((parseInt(this.screenData[this.screenIndex][model.link].value) || 0) >= 10000) validated = true;
                        else validated = false;
                    } else {
                        if (this.screenData[this.screenIndex][model.link].value.length !== 0) validated = false;
    ...
    methods: {
        tc: function () {
            if (['input1', 'input4', 'input6', 'input8'].includes(this.screenData[this.screenIndex].focusModel)) {
        ...
        set: function (value) {
            if ((this.screenIndex === 1 && ['input2'].includes(this.screenData[this.screenIndex].focusModel)) || (this.screenIndex === 2 && ['input2', 'input5', 'input7', 'input9'].includes(this.screenData[this.screenIndex].focusModel))) {
        ...
        backspace: function () {
            ...
            if (value === 'TC') model.value = '';
            else model.value = value.substr(0, value.length - 1);
        },
        submit: function () {
            if ((this.screenIndex === 1
                && this.screenData[1].input1.value.toString() === "1"
                && this.screenData[1].input2.value.toString() === "50000"
                && this.screenData[1].input3.value.toString() === "3D+"
            ) || (this.screenIndex === 2
                && this.screenData[2].input3.value.toString() === "3D+"
                && this.screenData[2].input1.value.toString() === "TC"
                && this.screenData[2].input2.value.toString() === "50000"
                && this.screenData[2].input4.value.toString() === ""
                && this.screenData[2].input5.value.toString() === ""
                && this.screenData[2].input6.value.toString() === ""
                && this.screenData[2].input7.value.toString() === ""
                && this.screenData[2].input8.value.toString() === ""
                && this.screenData[2].input9.value.toString() === ""
            )){
