export default {
    template: `<div class="screens">
        ...
        <button @click="screenIndex++"style="width: 200px; height: 40px; left: 10px; top: 295px; background-color: #fb7ae0; font-weight: bold;">
        ...
        <div id="popup_ticket" class="modal">
          ...
          <div class="modal-content">
            ...
            <img src="./images/Ticket_game/14.png" width="400" height="400" style="margin-left: auto; margin-right: auto;">
          </div>
        </div>
        <!-- End Ticket result -->
        ...
        <input @click="screenData[1].focusModel = 'input1'" v-model="screenData[1].input1.value" :class="{focus: screenData[1].focusModel === 'input1'}" class="three-d-input" type="text" style="top: 65px; left: 215px; height: 65px; width: 82px;" readonly>
        <input @click="screenData[1].focusModel = 'input2'" v-model="screenData[1].input2.value" :class="{focus: screenData[1].focusModel === 'input2'}" class="three-d-input" type="text" style="top: 65px; left: 300px; height: 65px; width: 82px;" readonly> 
         
        <label style="top: 153px; left: 200px; font-size: 14px;">B</label>
        <input @click="screenData[1].focusModel = 'input4'" v-model="screenData[1].input4.value" :class="{focus: screenData[1].focusModel === 'input4'}" class="three-d-input" type="text" style="top: 130px; left: 215px; height: 65px; width: 82px;" readonly>
        <input @click="screenData[1].focusModel = 'input5'" v-model="screenData[1].input5.value" :class="{focus: screenData[1].focusModel === 'input5'}" class="three-d-input" type="text" style="top: 130px; left: 300px; height: 65px; width: 82px;" readonly>  
         
        <label style="top: 218px; left: 200px; font-size: 14px;">C</label>
        <input @click="screenData[1].focusModel = 'input6'" v-model="screenData[1].input6.value" :class="{focus: screenData[1].focusModel === 'input6'}" class="three-d-input" type="text" style="top: 195px; left: 215px; height: 65px; width: 82px;" readonly>
        <input @click="screenData[1].focusModel = 'input7'" v-model="screenData[1].input7.value" :class="{focus: screenData[1].focusModel === 'input7'}" class="three-d-input" type="text" style="top: 195px; left: 300px; height: 65px; width: 82px;" readonly>  
         
        <label style="top: 283px; left: 200px; font-size: 14px;">D</label>
        <input @click="screenData[1].focusModel = 'input8'" v-model="screenData[1].input8.value" :class="{focus: screenData[1].focusModel === 'input8'}" class="three-d-input" type="text" style="top: 260px; left: 215px; height: 65px; width: 82px;" readonly>
        <input @click="screenData[1].focusModel = 'input9'" v-model="screenData[1].input9.value" :class="{focus: screenData[1].focusModel === 'input9'}" class="three-d-input" type="text" style="top: 260px; left: 300px; height: 65px; width: 82px;" readonly>  
    ...
    methods: {
        set: function (value) {
            if (['input2', 'input5', 'input7', 'input9'].includes(this.screenData[this.screenIndex].focusModel)) {
        ...
        submit: function () {
            if (
                this.screenData[1].input1.value.toString() === "299"
                && this.screenData[1].input2.value.toString() === "30000"
