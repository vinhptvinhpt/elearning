...
class moodle1_mod_page_handler extends moodle1_resource_successor_handler {
    ...
    public function process_legacy_resource(array $data, array $raw = null) {
        ...
        $this->fileman = $this->converter->get_file_manager($contextid, 'mod_gamebgt');
        ...
        // write page.xml
        $this->open_xml_writer("activities/page_{$moduleid}/gamebgt.xml");
        $this->xmlwriter->begin_tag('activity', array('id' => $instanceid, 'moduleid' => $moduleid,
            'modulename' => 'page', 'contextid' => $contextid));
        $this->write_xml('gamebgt', $page, array('/page/id'));
