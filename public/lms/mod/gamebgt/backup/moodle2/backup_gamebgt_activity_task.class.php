...
require_once($CFG->dirroot . '/mod/gamebgt/backup/moodle2/backup_gamebgt_stepslib.php');

/**
 * Provides the steps to perform one complete backup of the Page instance
 */
class backup_gamebgt_activity_task extends backup_activity_task {
    ...
    protected function define_my_steps() {
        $this->add_step(new backup_gamebgt_activity_structure_step('page_structure', 'gamebgt.xml'));
    }
