...
require_once($CFG->dirroot . '/mod/finalsurvey/backup/moodle2/restore_finalsurvey_stepslib.php'); // Because it exists (must)

/**
 * page restore task that provides all the settings and steps to perform one
 * complete restore of the activity
 */
class restore_finalsurvey_activity_task extends restore_activity_task {
    ...
    protected function define_my_steps() {
        ...
        $this->add_step(new restore_finalsurvey_activity_structure_step('page_structure', 'finalsurvey.xml'));
    }
