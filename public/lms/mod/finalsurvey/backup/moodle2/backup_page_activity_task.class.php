...
require_once($CFG->dirroot . '/mod/finalsurvey/backup/moodle2/backup_page_stepslib.php');
...
class backup_page_activity_task extends backup_activity_task {
    ...
    protected function define_my_steps() {
        $this->add_step(new backup_page_activity_structure_step('page_structure', 'finalsurvey.xml'));
    }
