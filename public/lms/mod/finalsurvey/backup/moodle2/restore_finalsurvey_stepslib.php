...
/**
 * Define all the restore steps that will be used by the restore_finalsurvey_activity_task
 */

/**
 * Structure step to restore one page activity
 */
class restore_finalsurvey_activity_structure_step extends restore_activity_structure_step {
    ...
    protected function process_finalsurvey($data) {
        global $DB;
