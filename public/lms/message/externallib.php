...
class core_message_external extends external_api {
    ...
    public static function mark_notification_read($notificationid, $timeread) {
        ...
        // $notification = $DB->get_record('tms_nofitication_logs', ['id' => $params['notificationid']], '*', MUST_EXIST);
        ...
        $sql = "SELECT
                ...
                WHERE
                    TNL.id = ".$notificationid;
        $notification = array_values($DB->get_records_sql($sql))[0];
        ...
        \core_message\api::mark_notification_as_read($notification, $timeread, $USER->id);
