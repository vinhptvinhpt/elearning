...
class renderer extends \plugin_renderer_base {
    ...
    public function render_tree(tree $tree) {
        ...
        // [VinhPT] hide unused categories and nodes
        $hidden_categories = array("coursedetails", "privacyandpolicies", "mobile");
        $hidden_nodes = array("blogs", "learningplans");
        foreach ($categories as $category) {
            if (in_array($category->name, $hidden_categories)){
                continue;
            }
