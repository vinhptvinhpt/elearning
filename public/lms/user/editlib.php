...
function useredit_shared_definition(&$mform, $editoroptions, $filemanageroptions, $user) {
    ...
    // [VinhPT] Remove description form for user profile
    ...
    if (empty($USER->newadminuser)) {
        ...
        // [VinhPT] Remove description for picture form for user profile
        // $mform->addElement('text', 'imagealt', get_string('imagealt'), 'maxlength="100" size="30"');
        // $mform->setType('imagealt', PARAM_TEXT);

    }

    // [VinhPT] Remove additional_name, interest, optional form for user profile
