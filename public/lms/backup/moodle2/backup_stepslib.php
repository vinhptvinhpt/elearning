...
class backup_course_structure_step extends backup_structure_step {
    ...
    protected function define_structure() {
        ...
        // Define each element separated
        // [VinhPT] Additional information: course_avatar, course_place, allow_register, is_certificate, total_date_course, is_end_quiz
        $course = new backup_nested_element('course', array('id', 'contextid'), array(
            ...
            'requested',
            'enablecompletion', 'completionstartonenrol', 'completionnotify', 'course_avatar', 'course_place', 'allow_register', 'is_certificate', 'total_date_course', 'is_end_quiz'));
