...
class core_course_category implements renderable, cacheable_object, IteratorAggregate {
    ...
    protected static function get_course_records($whereclause, $params, $options, $checkvisibility = false) {
        global $DB, $USER;
        $ctxselect = context_helper::get_preload_record_columns_sql('ctx');
        // [VinhPT][13.11.2019] Add is_end_quiz category in list course
        ...
        //TODO
        // [VinhPT][04.10.2019]
        // Filter category not equal 2 (THƯ VIỆN KHOÁ HỌC)
        // $fulloption = strval($options['viewmoretext']);
        // if ($fulloption == "All courses"){
        //     $sql = "SELECT ". join(',', $fields). ", $ctxselect
        //     FROM {course} c
        //     JOIN {context} ctx ON c.id = ctx.instanceid AND ctx.contextlevel = :contextcourse
        //     WHERE ". $whereclause." and c.category <> 2"." ORDER BY c.sortorder";
