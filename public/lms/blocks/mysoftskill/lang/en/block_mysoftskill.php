...
/**
 * Lang strings for the My softskill block.
 *
...
$string['aria:controls'] = 'Course softskill controls';
...
$string['list'] = 'List';
$string['mysoftskill:myaddinstance'] = 'Add a new course softskill block to Dashboard';
$string['past'] = 'Past';
$string['pluginname'] = 'Course softskill';
$string['privacy:metadata:softskillsortpreference'] = 'The Course softskill block sort preference.';
$string['privacy:metadata:softskillviewpreference'] = 'The Course softskill block view preference.';
$string['privacy:metadata:softskillgroupingpreference'] = 'The Course softskill block grouping preference.';
$string['privacy:metadata:softskillpagingpreference'] = 'The Course softskill block paging preference.';
...
$string['defaulttab_desc'] = 'The tab that will be displayed when a user first views their course softskill. When returning to their course softskill, the user\'s active tab is remembered.';
...
$string['privacy:metadata:softskilllasttab'] = 'This stores the last tab selected by the user on the softskill block.';
...
$string['softskilltitle'] = 'SOFTSKILL COURSES';