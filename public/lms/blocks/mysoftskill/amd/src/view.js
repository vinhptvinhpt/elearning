...
define(
    ...
    function(
        ...
        var TEMPLATES = {
            COURSES_CARDS: 'block_mysoftskill/view-cards',
            COURSES_LIST: 'block_mysoftskill/view-list',
            COURSES_SUMMARY: 'block_mysoftskill/view-summary',
        ...
        var DEFAULT_PAGED_CONTENT_CONFIG = {
            ...
            persistentLimitKey: 'block_mysoftskill_user_paging_preference'
        };
         ...
         */
        var getMyCourses = function(filters, limit, form) {
        ...
        var initializePagedContent = function(root) {
            namespace = "block_mysoftskill_" + root.attr('id') + "_" + Math.random();
        ...
        var registerEventListeners = function(root) {
            ...
            root.on(CustomEvents.events.activate, SELECTORS.ACTION_HIDE_COURSE, function(e, data) {
                ...
                var request = {
                    preferences: [{
                        type: 'block_mysoftskill_hidden_course_' + id,
                        value: true
                    }]
                };
