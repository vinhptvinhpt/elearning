...
function(
    ...
    var updatePreferences = function(filter, value) {
        var type = null;
        if (filter == 'display') {
            type = 'block_mysoftskill_user_view_preference';
        } else if (filter == 'sort') {
            type = 'block_mysoftskill_user_sort_preference';
        } else {
            type = 'block_mysoftskill_user_grouping_preference';
        }
