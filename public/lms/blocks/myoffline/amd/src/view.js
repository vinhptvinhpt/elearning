...
define(
    ...
    function(
        ...
        var TEMPLATES = {
            COURSES_CARDS: 'block_myoffline/view-cards',
            COURSES_LIST: 'block_myoffline/view-list',
            COURSES_SUMMARY: 'block_myoffline/view-summary',
        ...
        var DEFAULT_PAGED_CONTENT_CONFIG = {
            ...
            persistentLimitKey: 'block_myoffline_user_paging_preference'
        };
        ...
        var initializePagedContent = function(root) {
            namespace = "block_myoffline_" + root.attr('id') + "_" + Math.random();
        ...
        var registerEventListeners = function(root) {
            ...
            root.on(CustomEvents.events.activate, SELECTORS.ACTION_HIDE_COURSE, function(e, data) {
                ...
                var request = {
                    preferences: [{
                        type: 'block_myoffline_hidden_course_' + id,
                        value: true
                    }]
                };
