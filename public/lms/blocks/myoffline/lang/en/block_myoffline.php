...
/**
 * Lang strings for the My offline block.
 *
...
$string['aria:controls'] = 'Course offline controls';
...
$string['list'] = 'List';
$string['myoffline:myaddinstance'] = 'Add a new course offline block to Dashboard';
$string['past'] = 'Past';
$string['pluginname'] = 'Course offline';
$string['privacy:metadata:offlinesortpreference'] = 'The Course offline block sort preference.';
$string['privacy:metadata:offlineviewpreference'] = 'The Course offline block view preference.';
$string['privacy:metadata:offlinegroupingpreference'] = 'The Course offline block grouping preference.';
$string['privacy:metadata:offlinepagingpreference'] = 'The Course offline block paging preference.';
...
$string['defaulttab_desc'] = 'The tab that will be displayed when a user first views their course offline. When returning to their course offline, the user\'s active tab is remembered.';
...
$string['privacy:metadata:offlinelasttab'] = 'This stores the last tab selected by the user on the offline block.';
...
$string['offlinetitle'] = 'OFFLINE COURSE';
