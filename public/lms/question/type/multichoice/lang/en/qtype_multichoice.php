...
$string['clearchoice'] = 'Chọn lại';
$string['clozeaid'] = 'Enter missing word';
$string['correctansweris'] = 'Câu trả lời đúng là: {$a}';
$string['correctanswersare'] = 'Những câu trả lời đúng là: {$a}';
...
$string['selectmulti'] = 'Chọn 1 hoặc nhiều đáp án:';
$string['selectone'] = 'Chọn 1 đáp án:';
