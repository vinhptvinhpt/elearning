...
/**
 * Privacy Subsystem implementation for theme_bgtlms.
 *
...
namespace theme_bgtlms\privacy;
...
class provider implements
    ...
    public static function export_user_preferences(int $userid) {
        ...
        if (isset($draweropennavpref)) {
            $preferencestring = get_string('privacy:drawernavclosed', 'theme_bgtlms');
            if ($draweropennavpref == 'true') {
                $preferencestring = get_string('privacy:drawernavopen', 'theme_bgtlms');
            }
