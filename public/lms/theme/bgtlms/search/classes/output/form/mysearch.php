...
class mysearch extends search {
    ...
    function definition() {
        ...
        $mform =& $this->_form;
//
//        if (manager::is_search_area_categories_enabled() && !empty($this->_customdata['cat'])) {
...
//        $mform->disable_form_change_checker();
        ...
        $search = manager::instance(true);
        $enabledsearchareas = manager::get_search_areas_list(true);
        $areanames = array();

        if (manager::is_search_area_categories_enabled() && !empty($this->_customdata['cat'])) {
            $searchareacategory = manager::get_search_area_category_by_name($this->_customdata['cat']);
