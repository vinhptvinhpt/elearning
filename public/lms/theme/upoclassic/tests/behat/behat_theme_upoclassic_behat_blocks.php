...
/**
 * Step definitions related to blocks overrides for the UPO Boost theme.
 *
...
/**
 * Blocks management step definitions for the UPO Boost theme.
 *
 * @package    theme_upoclassic
 * @category   test
 * @copyright  2019 Michael Hawkins
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class behat_theme_upoclassic_behat_blocks extends behat_blocks {
