...
/**
 * Behat grade related step definition overrides for the UPO Boost theme.
 *
...
/**
 * Behat grade overrides for the UPO Boost theme.
 *
 * @package    theme_upoclassic
 * @category   test
 * @copyright  2019 Michael Hawkins
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class behat_theme_upoclassic_behat_grade extends behat_grade {
