...
/**
 * Navigation step definition overrides for the UPO Boost theme.
 *
...
/**
 * Step definitions and overrides to navigate through the navigation tree nodes in the UPO Boost theme.
 *
 * @package    theme_upoclassic
 * @category   test
 * @copyright  2019 Michael Hawkins
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class behat_theme_upoclassic_behat_navigation extends behat_navigation {
    /**
