...
/**
 * Override definitions for the upload repository type for the UPO Boost theme.
 *
...
/**
 * Override step definitions to deal with the upload repository in the UPO Boost theme.
 *
 * @package    theme_upoclassic
 * @category   test
 * @copyright  2019 Michael Hawkins
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class behat_theme_upoclassic_behat_repository_upload extends behat_repository_upload {
