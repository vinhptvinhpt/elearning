...
$THEME->extrascsscallback = 'theme_upoclassic_get_extra_scss';
$THEME->prescsscallback = 'theme_upoclassic_get_pre_scss';
$THEME->precompiledcsscallback = 'theme_upoclassic_get_precompiled_css';
$THEME->yuicssmodules = array();
$THEME->rendererfactory = 'theme_overridden_renderer_factory';
$THEME->scss = function($theme) {
    return theme_upoclassic_get_main_scss_content($theme);
};
