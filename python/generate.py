            ...
            if (get_user_id == 0):
                ...
                for row in records:
                    ...
                    try:
                        ...
                        name_utf8_trainning = trainning_name
                        # name_utf8_branch = branch_name.decode('utf8')
                        #address_utf8_branch = branch_address.decode('utf8')
                        # create the canvas
                        canvas = ImageDraw.Draw(img)
                        # set font
                        font_name = ImageFont.truetype(os.path.join(path, 'Lato-Bold.ttf'), size=30)
                        font_trainning = ImageFont.truetype(os.path.join(path, 'Lato-Bold.ttf'), size=26)
                        ...
                        trainning_width, trainning_height = canvas.textsize(name_utf8_trainning, font=font_trainning)
                        ...
                        # set datetime
                        canvas.text((380, 725), str(now.day)+'/', font=font_date, fill='#111111')
                        canvas.text((409, 725), str(now.month)+'/', font=font_date, fill='#111111')
                        canvas.text((438, 725), str(now.year), font=font_date, fill='#111111')
                        # set name to position
                        canvas.text(((image_width - trainning_width) / 2, 574), name_utf8_trainning, font=font_trainning, fill='#111111')
                        # canvas.text((2105, 1585), address_utf8_branch, font=font_name, fill='#060836')
                        canvas.text(((image_width - name_width - 20) / 2, 430),
