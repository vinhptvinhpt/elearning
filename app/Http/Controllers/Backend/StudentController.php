...
class StudentController extends Controller
{
    ...
    public function __construct(BussinessRepository $bussinessRepository, StudentRepository $studentRepository)
    {
    ...
    public function apiCheckCerExist(Request $request)
    {
        return $this->studentRepository->checkImageExist($request);
    }
}
