...
class BranchSheet implements WithTitle, WithHeadings, FromArray, WithMapping, ShouldAutoSize, WithEvents
{
    private $title;
    ...
    public function _getRowBy($row) //overwrite row data if necessary
    {
        ...
        $row = [
            !empty($row['agencyname']) ? $row['agencyname'] : '',
