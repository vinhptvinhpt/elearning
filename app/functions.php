...
function permission_cat_name()
{
    $cat_array = [
        ...
        'tms-system-user' => 'Quản lý người dùng',
        'tms-system-teacher' => 'Quản lý Giảng viên',
        ...
        'tms-educate-exam' => 'Quản lý Khóa học',
        'tms-educate-exam-online' => 'Khóa đào tạo online',
        'tms-educate-exam-offline' => 'Khóa đào tạo tập trung',
        'tms-educate-exam-clone' => 'Tạo mới khóa từ thư viện',
        ...
        'tms-report' => 'Báo cáo',
        'tms-report-survey' => 'Quản lý Survey',
        'tms-report-base' => 'Thống kê sơ bộ',
        'tms-report-report' => 'Báo cáo đánh giá',
        'tms-setting-configuration' => 'Cấu hình chung',
        'tms-setting-email-template' => 'Email Template',
        'tms-setting-notification' => 'Notification',
        'tms-support' => 'Hỗ trợ',
        'tms-elearning' => 'Elearning',
        'tms-educate-libraly' => 'Thư viện khóa học',
        'tms-notification' => 'Thông báo',
        'tms-access-profile' => 'Truy cập thông tin cá nhân',
        'tms-access-market' => 'Truy cập dữ liệu ( Của nhân viên giám sát thị trường được cấp )',
        ...
        'nav_system' => '<i class="fa fa-database"></i> Quản lý hệ thống',
        'nav_educate' => '<i class="fa fa-book"></i> Quản lý đào tạo',
        'nav_report' => '<i class="fa fa-bell-o"></i> Báo cáo',
        'nav_setting' => '<i class="fa fa-cog"></i> Cấu hình hệ thống',
        'nav_access' => 'Quyền truy cập',
        'nav_support' => 'Hỗ trợ',
    ];
    return $cat_array;
}
    ...
    $slug_array = [
        ...
        'nav_system' => [
            'tms-system-organize' => [
                ...
                'tms-system-organize-edit' => 'Sửa',
                'tms-system-organize-deleted' => 'Xóa',
            ],
            'tms-system-user' => [
                'tms-system-user-view' => 'Xem',
                'tms-system-user-add' => 'Thêm',
...
//            tms-system-employee
            'tms-system-market' => [
                ...
                'tms-system-market-edit' => 'Sửa',
                'tms-system-market-deleted' => 'Xóa',
            ],
            'tms-system-teacher' => [
                'tms-system-teacher-view' => 'Xem',
                'tms-system-teacher-add' => 'Thêm',
                'tms-system-teacher-edit' => 'Sửa',
                'tms-system-teacher-deleted' => 'Xóa',
            ],
            'tms-system-student' => [
                'tms-system-student-view' => 'Xem',
                'tms-system-student-add' => 'Thêm',
                'tms-system-student-edit' => 'Sửa',
                'tms-system-student-deleted' => 'Xóa',
            ],
            'tms-system-role' => [
                'tms-system-role-view' => 'Xem',
                'tms-system-role-add' => 'Thêm',
                'tms-system-role-edit' => 'Sửa',
                'tms-system-role-deleted' => 'Xóa',
            ],
            'tms-system-trash' => [
                'tms-system-trash-restore' => 'Khôi phục',
                'tms-system-trash-clear' => 'Xóa vĩnh viễn',
            ],
        ...
        'nav_educate' => [
            ...
            'tms-educate-exam-online' => [
                ...
                'tms-educate-exam-online-edit' => 'Sửa',
                'tms-educate-exam-online-deleted' => 'Xóa',
            ],
            'tms-educate-exam-offline' => [
                'tms-educate-exam-offline-view' => 'Xem',
                'tms-educate-exam-offline-add' => 'Thêm',
                'tms-educate-exam-offline-edit' => 'Sửa',
                'tms-educate-exam-offline-deleted' => 'Xóa',
            ],
            'tms-educate-exam-clone' => [
                'tms-educate-exam-clone-add' => 'Thêm',
            ],
            'tms-educate-exam-restore' => [
                'tms-educate-exam-restore-view' => 'Xem',
                'tms-educate-exam-restore-add' => 'Thêm',
                'tms-educate-exam-restore-edit' => 'Sửa',
                'tms-educate-exam-restore-deleted' => 'Xóa',
            ],
            'tms-educate-uncertificate' => [
                'tms-educate-uncertificate-view' => 'Xem',
                'tms-educate-uncertificate-add' => 'Thêm',
                'tms-educate-uncertificate-edit' => 'Sửa',
                'tms-educate-uncertificate-deleted' => 'Xóa',
            ],
            'tms-educate-certificate' => [
                'tms-educate-certificate-view' => 'Xem',
                'tms-educate-certificate-add' => 'Thêm',
            ...
            'tms-trainning' => [
                ...
                'tms-trainning-add' => 'Thêm',
                'tms-trainning-edit' => 'Sửa',
                'tms-trainning-deleted' => 'Xóa',
            ],
            /*'tms-educate-exam' => [
        ...
        'nav_report' => [
            'tms-report-survey' => [
                'tms-report-survey-view' => 'Xem',
                'tms-report-survey-add' => 'Thêm',
                'tms-report-survey-edit' => 'Sửa',
                'tms-report-survey-deleted' => 'Xóa',
            ],
            'tms-report-base' => [
                'tms-report-base-view' => 'Xem',
                /*'tms-report-base-add' => 'Thêm',
                'tms-report-base-edit' => 'Sửa',
                'tms-report-base-deleted' => 'Xóa',*/
            ],
            'tms-report-report' => [
                'tms-report-report-view' => 'Xem',
        ...
        'nav_setting' => [
            'tms-setting-configuration' => [
                'tms-setting-configuration-view' => 'Cập nhật',/*
            ...
            'tms-setting-email-template' => [
                'tms-setting-email-template-view' => 'Cập nhật',
            ...
            'tms-setting-notification' => [
                'tms-setting-notification-view' => 'Cập nhật',
        ...
        'nav_support' => [
            'tms-support' => [
                'tms-support-market-view' => 'Xem Hướng dẫn cho chuyên viên kinh doanh',
                'tms-support-admin-view' => 'Xem Hướng dẫn cho quản lý hệ thống',
            ],
        ],
    ];
    return $slug_array;
